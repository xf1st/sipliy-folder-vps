...
app.use(session({
  ...
  rolling: true,
  cookie: { maxAge: 30 * 24 * 60 * 60 * 1000, httpOnly: true }, // 30 ╨┤╨╜╨╡╨╣, ╨╛╨▒╨╜╨╛╨▓╨╗╤П╨╡╤В╤Б╤П ╨┐╤А╨╕ ╨║╨░╨╢╨┤╨╛╨╝ ╨а┬а╨Т┬╖╨а┬а╨Т┬░╨а┬а╨бтАФ╤А╨╛╤Б╨╡
}));
...
// тФАтФАтФА Routes тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
app.get('/api/disk', auth, (req, res) => {
  ...
  res.json({ total: 'тАФ', used: 'тАФ', avail: 'тАФ', percent: 0 });
});
...
app.post('/api/add', auth, async (req, res) => {
  ...
  if (!dlUrl) return res.status(400).json({ error: 'URL ╨┐╤Г╤Б╤В╨╛╨╣' });
  const dir = userDir(req.session.user);
  try {
    const opts = { dir };
...
// тФАтФАтФА VirusTotal тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
app.get('/api/vt/:file', auth, async (req, res) => {
  ...
  if (!fs.existsSync(filePath)) return res.status(404).json({ error: '╨д╨░╨╣╨╗ ╨╜╨╡ ╨╜╨░╨╣╨┤╨╡╨╜' });
  ...
  try {
    ...
    // Not in VT тАФ upload file (only if <= 32MB)
    const size = fs.statSync(filePath).size;
    if (size > 32 * 1024 * 1024) {
      return res.json({ hash, pending: true, message: '╨д╨░╨╣╨╗ > 32 ╨Ь╨С, ╨┐╤А╨╛╨▓╨╡╤А╨║╨░ ╨┐╨╛ ╤Е╤Н╤И╤Г: ╨╜╨╡ ╨╜╨░╨╣╨┤╨╡╨╜ ╨▓ ╨▒╨░╨╖╨╡ VT' });
    }
    ...
    res.json({ hash, pending: true, message: '╨Р╨╜╨░╨╗╨╕╨╖ ╨╖╨░╨┐╤Г╤Й╨╡╨╜, ╨┐╨╛╨┐╤А╨╛╨▒╤Г╨╣╤В╨╡ ╤З╨╡╤А╨╡╨╖ ╨╝╨╕╨╜╤Г╤В╤Г' });
  } catch (e) {
...
// тФАтФАтФА Public share links тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
app.post('/share/:token/auth', (req, res) => {
  ...
  res.send(sharePasswordPage(req.params.token, '╨Э╨╡╨▓╨╡╤А╨╜╤Л╨╣ ╨┐╨░╤А╨╛╨╗╤М'));
});
...
// ╨Ю╤З╨╕╤Б╤В╨║╨░ ╨╛╤И╨╕╨▒╨╛╨║ aria2 (╤Г╨┤╨░╨╗╤П╨╡╤В ╨╖╨░╨┐╨╕╤Б╨╕ ╤Б status=error ╨╕╨╖ ╨┐╨░╨╝╤П╤В╨╕ aria2, ╤Д╨░╨╣╨╗╤Л ╨╜╨╡ ╤В╤А╨╛╨│╨░╨╡╤В)
...
// ╨Р╨║╤В╨╕╨▓╨╜╤Л╨╡ ╨╖╨░╨│╤А╤Г╨╖╨║╨╕ ╨┤╨╗╤П ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П (Bearer-auth)
...
// ╨б╨╛╨╖╨┤╨░╤В╤М ╨┐╤Г╨▒╨╗╨╕╤З╨╜╤Г╤О ╤Б╤Б╤Л╨╗╨║╤Г ╨╕╨╖ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П
app.post('/api/ext/share', extCors, authToken, (req, res) => {
  ...
  if (!fs.existsSync(fullPath)) return res.set(EXT_CORS).json({ ok: false, error: '╨д╨░╨╣╨╗ ╨╜╨╡ ╨╜╨░╨╣╨┤╨╡╨╜' });
  const token = crypto.randomUUID();
  const shares = loadShares();
...
app.get('/ext/update', (req, res) => {
  ...
  const dlBtn = zipExists
    ? `<a class="btn" href="/ext/extension.zip" download>тмЗ ╨б╨║╨░╤З╨░╤В╤М ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╨╡ v${EXT_VERSION}</a>`
    : `<p style="color:#dc2626;font-size:.82rem">╨Р╤А╤Е╨╕╨▓ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П ╨╡╤Й╤С ╨╜╨╡ ╨╖╨░╨│╤А╤Г╨╢╨╡╨╜ ╨╜╨░ ╤Б╨╡╤А╨▓╨╡╤А.</p>`;
  res.send(`<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>╨Ю╨▒╨╜╨╛╨▓╨╗╨╡╨╜╨╕╨╡ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П тАФ v${EXT_VERSION}</title>
...
<body><div class="card">
<h1>ЁЯФД ╨Ю╨▒╨╜╨╛╨▓╨╗╨╡╨╜╨╕╨╡ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П</h1>
<div class="ver">v${EXT_VERSION}</div>
<p>╨Э╨╛╨▓╨░╤П ╨▓╨╡╤А╤Б╨╕╤П ╨┤╨╛╤Б╤В╤Г╨┐╨╜╨░ ╨┤╨╗╤П ╤Г╤Б╤В╨░╨╜╨╛╨▓╨║╨╕. ╨б╨╗╨╡╨┤╤Г╨╣╤В╨╡ ╨╕╨╜╤Б╤В╤А╤Г╨║╤Ж╨╕╨╕ ╨╜╨╕╨╢╨╡:</p>
${dlBtn}
<ol>
  <li>╨б╨║╨░╤З╨░╨╣╤В╨╡ ╨░╤А╤Е╨╕╨▓ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П (╨║╨╜╨╛╨┐╨║╨░ ╨▓╤Л╤И╨╡)</li>
  <li>╨а╨░╤Б╨┐╨░╨║╤Г╨╣╤В╨╡ ╨╡╨│╨╛ ╨▓ ╨╗╤О╨▒╤Г╤О ╨┐╨░╨┐╨║╤Г</li>
  <li>╨Ю╤В╨║╤А╨╛╨╣╤В╨╡ <code style="background:#2e2a38;padding:2px 6px;border-radius:4px">chrome://extensions</code></li>
  <li>╨Т╨║╨╗╤О╤З╨╕╤В╨╡ <b>╨а╨╡╨╢╨╕╨╝ ╤А╨░╨╖╤А╨░╨▒╨╛╤В╤З╨╕╨║╨░</b> (╨┐╨╡╤А╨╡╨║╨╗╤О╤З╨░╤В╨╡╨╗╤М ╤Б╨┐╤А╨░╨▓╨░)</li>
  <li>╨Э╨░╨╢╨╝╨╕╤В╨╡ <b>┬л╨Ч╨░╨│╤А╤Г╨╖╨╕╤В╤М ╤А╨░╤Б╨┐╨░╨║╨╛╨▓╨░╨╜╨╜╨╛╨╡┬╗</b> ╨╕ ╨▓╤Л╨▒╨╡╤А╨╕╤В╨╡ ╨┐╨░╨┐╨║╤Г</li>
</ol>
<p class="note">╨Х╤Б╨╗╨╕ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╨╡ ╤Г╨╢╨╡ ╤Г╤Б╤В╨░╨╜╨╛╨▓╨╗╨╡╨╜╨╛ ╤З╨╡╤А╨╡╨╖ ╤Н╤В╤Г ╨┐╨░╨┐╨║╤Г тАФ ╨┐╤А╨╛╤Б╤В╨╛ ╨╜╨░╨╢╨╝╨╕╤В╨╡ ┬лтЖ╗ ╨Ю╨▒╨╜╨╛╨▓╨╕╤В╤М┬╗ ╨▓ chrome://extensions</p>
</div></body></html>`);
});

// ╨б╨║╨░╤З╨░╤В╤М zip ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П
...
// ╨б╨║╨░╤З╨░╤В╤М ╤Д╨░╨╣╨╗ ╤З╨╡╤А╨╡╨╖ ╤В╨╛╨║╨╡╨╜ ╨▓ query-╨┐╨░╤А╨░╨╝╨╡╤В╤А╨╡ (chrome.downloads ╨╜╨╡ ╤Г╨╝╨╡╨╡╤В ╤Б╨╗╨░╤В╤М ╨╖╨░╨│╨╛╨╗╨╛╨▓╨║╨╕)
...
// тФАтФАтФА User management тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
app.post('/api/users', auth, (req, res) => {
  ...
  if (!username || !password) return res.status(400).json({ error: '╨Ы╨╛╨│╨╕╨╜ ╨╕ ╨┐╨░╤А╨╛╨╗╤М ╨╛╨▒╤П╨╖╨░╤В╨╡╨╗╤М╨╜╤Л' });
  if (!/^[a-z0-9_]{2,32}$/.test(username)) return res.status(400).json({ error: '╨Ы╨╛╨│╨╕╨╜: ╤В╨╛╨╗╤М╨║╨╛ ╤Б╤В╤А╨╛╤З╨╜╤Л╨╡ ╨▒╤Г╨║╨▓╤Л, ╤Ж╨╕╤Д╤А╤Л, _ (2тАУ32 ╤Б╨╕╨╝╨▓╨╛╨╗╨░)' });
  const users = loadUsers();
  if (users[username]) return res.status(409).json({ error: '╨Я╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤М ╤Г╨╢╨╡ ╤Б╤Г╤Й╨╡╤Б╤В╨▓╤Г╨╡╤В' });
...
app.delete('/api/users/:username', auth, (req, res) => {
  ...
  if (target === req.session.user) return res.status(400).json({ error: '╨Э╨╡╨╗╤М╨╖╤П ╤Г╨┤╨░╨╗╨╕╤В╤М ╤Б╨╡╨▒╤П' });
  const users = loadUsers();
  if (!users[target]) return res.status(404).json({ error: '╨Я╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤М ╨╜╨╡ ╨╜╨░╨╣╨┤╨╡╨╜' });
  delete users[target];
  saveUsers(users);
  // ╨б╨▒╤А╨░╤Б╤Л╨▓╨░╨╡╨╝ ╤В╨╛╨║╨╡╨╜╤Л ╤Г╨┤╨░╨╗╤С╨╜╨╜╨╛╨│╨╛ ╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤П
  const tokens = loadTokens();
...
app.post('/api/change-password', auth, (req, res) => {
  ...
  if (!newPassword || newPassword.length < 6) return res.status(400).json({ error: '╨Э╨╛╨▓╤Л╨╣ ╨┐╨░╤А╨╛╨╗╤М ╨╝╨╕╨╜╨╕╨╝╤Г╨╝ 6 ╤Б╨╕╨╝╨▓╨╛╨╗╨╛╨▓' });
  const users = loadUsers();
  const me = users[req.session.user];
  if (!me) return res.status(404).json({ error: '╨Я╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤М ╨╜╨╡ ╨╜╨░╨╣╨┤╨╡╨╜' });
  if (me.password !== currentPassword) return res.status(403).json({ error: '╨Э╨╡╨▓╨╡╤А╨╜╤Л╨╣ ╤В╨╡╨║╤Г╤Й╨╕╨╣ ╨┐╨░╤А╨╛╨╗╤М' });
...
// тФАтФАтФА Upload тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
app.post('/api/upload', auth, upload.array('files', 50), (req, res) => {
  if (!req.files || !req.files.length) return res.status(400).json({ error: '╨Э╨╡╤В ╤Д╨░╨╣╨╗╨╛╨▓' });
...
// тФАтФАтФА File Manager helper тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
...
app.post('/api/fm/mkdir', auth, (req, res) => {
  ...
  if (!name) return res.status(400).json({ error: '╨Э╨╡ ╤Г╨║╨░╨╖╨░╨╜╨╛ ╨╕╨╝╤П' });
  const combined = parentRel ? (parentRel + '/' + name) : name;
  const full = fmResolve(req.session.user, combined);
  if (!full) return res.status(403).json({ error: 'Invalid path' });
  if (fs.existsSync(full)) return res.status(409).json({ error: '╨г╨╢╨╡ ╤Б╤Г╤Й╨╡╤Б╤В╨▓╤Г╨╡╤В' });
...
app.post('/api/fm/rename', auth, (req, res) => {
  ...
  if (!oldPath || !newName) return res.status(400).json({ error: '╨Э╨╡╨▓╨╡╤А╨╜╤Л╨╡ ╨┐╨░╤А╨░╨╝╨╡╤В╤А╤Л' });
  ...
  if (fs.existsSync(to)) return res.status(409).json({ error: '╨г╨╢╨╡ ╤Б╤Г╤Й╨╡╤Б╤В╨▓╤Г╨╡╤В' });
  ...
  try {
    ...
    if (stat.isDirectory()) {
      ...
      if (inside && !inside.startsWith('..') && !path.isAbsolute(inside)) {
        return res.status(400).json({ error: '╨Э╨╡╨╗╤М╨╖╤П ╨┐╨╡╤А╨╡╨╝╨╡╤Б╤В╨╕╤В╤М ╨┐╨░╨┐╨║╤Г ╨▓╨╜╤Г╤В╤А╤М ╤Б╨░╨╝╨╛╨╣ ╤Б╨╡╨▒╤П' });
      }
    }
  } catch (e) {
...
function sharePasswordPage(token, errorMsg = '') {
  return '<!DOCTYPE html><html lang="ru"><head><title>╨Ч╨░╤Й╨╕╤Й╨╡╨╜╨╜╨░╤П ╤Б╤Б╤Л╨╗╨║╨░</title>' + HEAD + '</head>' +
  ...
  '<div class="relative w-full max-w-sm mx-4">' +
    '<div class="bg-surface-container-lowest/80 glass rounded-4xl p-10 shadow-[0_32px_80px_rgba(107,80,154,0.08)] text-center">' +
      ...
      '</div>' +
      '<h1 class="text-2xl font-headline font-extrabold text-on-primary-container tracking-tight">╨Ф╨╛╤Б╤В╤Г╨┐ ╨╛╨│╤А╨░╨╜╨╕╤З╨╡╨╜</h1>' +
      '<p class="text-secondary text-sm font-label mt-2 mb-6">╨н╤В╨░ ╤Б╤Б╤Л╨╗╨║╨░ ╨╖╨░╤Й╨╕╤Й╨╡╨╜╨░ ╨┐╨░╤А╨╛╨╗╨╡╨╝. ╨Т╨▓╨╡╨┤╨╕╤В╨╡ ╨┐╨░╤А╨╛╨╗╤М ╨┤╨╗╤П ╨┐╨╛╨╗╤Г╤З╨╡╨╜╨╕╤П ╨┤╨╛╤Б╤В╤Г╨┐╨░.</p>' +
      '<form method="POST" action="/share/' + token + '/auth" class="space-y-4">' +
        '<div>' +
          '<input name="password" type="password" required class="w-full bg-surface-container-low border-none rounded-2xl px-5 py-3.5 text-on-surface font-body focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-outline" placeholder="╨Я╨░╤А╨╛╨╗╤М ╨┤╨╛╤Б╤В╤Г╨┐╨░"/>' +
        '</div>' +
        (errorMsg ? '<div style="font-size:12px;font-weight:bold;color:#ffb4ab;margin-top:8px">' + htmlEscape(errorMsg) + '</div>' : '') +
        '<button type="submit" class="w-full btn-primary bg-primary hover:bg-primary-container text-white rounded-2xl py-3.5 font-bold transition-all shadow-md mt-4" style="width:100%">╨Я╨╛╨┤╤В╨▓╨╡╤А╨┤╨╕╤В╤М</button>' +
      '</form>' +
    '</div>' +
  '</div>' +
  '</body></html>';
...
function shareNotFoundPage() {
  return '<!DOCTYPE html><html lang="ru"><head><title>╨б╤Б╤Л╨╗╨║╨░ ╨╜╨╡╨┤╨╡╨╣╤Б╤В╨▓╨╕╤В╨╡╨╗╤М╨╜╨░</title>' + HEAD + '</head>' +
  '<body class="bg-background font-body text-on-surface min-h-screen flex items-center justify-center">' +
  '<div class="text-center">' +
    '<span class="material-symbols-outlined text-7xl text-outline-variant">link_off</span>' +
    '<h1 class="text-2xl font-headline font-bold text-on-primary-container mt-4 mb-2">╨б╤Б╤Л╨╗╨║╨░ ╨╜╨╡╨┤╨╡╨╣╤Б╤В╨▓╨╕╤В╨╡╨╗╤М╨╜╨░</h1>' +
    '<p class="text-secondary font-body">╨д╨░╨╣╨╗ ╨▒╤Л╨╗ ╤Г╨┤╨░╨╗╤С╨╜ ╨╕╨╗╨╕ ╤Б╤Б╤Л╨╗╨║╨░ ╨╛╤В╨╛╨╖╨▓╨░╨╜╨░.</p>' +
  '</div>' +
  '</body></html>';
}

// тФАтФАтФА HTML тФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФАтФА
function sharePreviewPage(s, token, filename, sizeStr) {
  ...
  if (isVideo) {
    ...
    previewHtml = `<div style="padding:60px 40px; background:#1e1a25; border-radius:8px; text-align:center; width:100%;"><span class="material-symbols-outlined" style="font-size:64px; color:#a078ff;">insert_drive_file</span><div style="margin-top:15px; color:#cbc3d7; font-size:16px;">╨Я╤А╨╡╨┤╨┐╤А╨╛╤Б╨╝╨╛╤В╤А ╨╜╨╡╨┤╨╛╤Б╤В╤Г╨┐╨╡╨╜ ╨┤╨╗╤П ╤Н╤В╨╛╨│╨╛ ╤Д╨╛╤А╨╝╨░╤В╨░ ╤Д╨░╨╣╨╗╨░</div></div>`;
  }
  ...
  '<div class="relative w-full max-w-sm mx-4">' +
    '<div class="bg-surface-container-lowest/80 glass rounded-4xl p-10 shadow-[0_32px_80px_rgba(107,80,154,0.08)]">' +
      '<div class="flex flex-col items-center mb-8">' +
        ...
        '<p class="text-secondary text-sm font-label mt-1">╨Т╨╛╨╣╨┤╨╕╤В╨╡ ╨▓ ╤Б╨▓╨╛╨╣ ╨░╨║╨║╨░╤Г╨╜╤В</p>' +
      '</div>' +
      '<form method="POST" action="/login" class="space-y-4">' +
        '<div><label class="text-xs font-label text-secondary uppercase tracking-widest mb-2 block">╨Ы╨╛╨│╨╕╨╜</label>' +
        '<input name="username" type="text" required autocomplete="username" class="w-full bg-surface-container-low border-none rounded-2xl px-5 py-3.5 text-on-surface font-body focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-outline" placeholder="╨Т╨░╤И ╨╗╨╛╨│╨╕╨╜"/></div>' +
        '<div><label class="text-xs font-label text-secondary uppercase tracking-widest mb-2 block">╨Я╨░╤А╨╛╨╗╤М</label>' +
        '<input name="password" type="password" required autocomplete="current-password" class="w-full bg-surface-container-low border-none rounded-2xl px-5 py-3.5 text-on-surface font-body focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-outline" placeholder="тАвтАвтАвтАвтАвтАвтАвтАв"/></div>' +
        (error ? '<div class="bg-red-50 text-error text-sm font-label px-4 py-3 rounded-2xl">тЪа ' + error + '</div>' : '') +
        '<button type="submit" class="w-full mt-2 py-4 bg-gradient-to-r from-primary to-primary-container text-white rounded-full font-headline font-bold text-sm tracking-tight shadow-xl shadow-primary/20 hover:opacity-90 active:scale-95 transition-all">╨Т╨╛╨╣╤В╨╕</button>' +
      '</form>' +
    '</div>' +
  '</div>' +
  '</body></html>';
...
function mainPage(username) {
  ...
  '<div class="flex flex-col p-5 h-full">' +
    ...
    '<nav class="flex-1 space-y-1">' +
      '<button onclick="showTab(\'downloads\')" id="nav-downloads" class="w-full flex items-center gap-3 bg-gradient-to-r from-primary to-primary-container text-white rounded-xl px-4 py-3 shadow-md shadow-purple-500/20 font-label text-sm">' +
        '<span class="material-symbols-outlined text-lg">download_for_offline</span> ╨Ч╨░╨│╤А╤Г╨╖╨║╨╕' +
      '</button>' +
      '<button onclick="showTab(\'files\')" id="nav-files" class="w-full flex items-center gap-3 text-secondary px-4 py-3 hover:bg-secondary-container/30 rounded-xl transition-all font-label text-sm text-left">' +
        '<span class="material-symbols-outlined text-lg">folder_open</span> ╨У╨╛╤В╨╛╨▓╤Л╨╡ ╤Д╨░╨╣╨╗╤Л' +
      '</button>' +
      '<button onclick="showTab(\'shares\')" id="nav-shares" class="w-full flex items-center gap-3 text-secondary px-4 py-3 hover:bg-secondary-container/30 rounded-xl transition-all font-label text-sm text-left">' +
        '<span class="material-symbols-outlined text-lg">link</span> ╨Я╤Г╨▒╨╗╨╕╤З╨╜╤Л╨╡ ╤Б╤Б╤Л╨╗╨║╨╕' +
      '</button>' +
      '<button onclick="window.location=\'/cloud\'" class="w-full flex items-center gap-3 text-secondary px-4 py-3 hover:bg-secondary-container/30 rounded-xl transition-all font-label text-sm text-left">' +
        '<span class="material-symbols-outlined text-lg">cloud</span> ╨д╨░╨╣╨╗╨╛╨▓╤Л╨╣ ╨╝╨╡╨╜╨╡╨┤╨╢╨╡╤А' +
      '</button>' +
      '<button onclick="openSettings()" class="w-full flex items-center gap-3 text-secondary px-4 py-3 hover:bg-secondary-container/30 rounded-xl transition-all font-label text-sm text-left">' +
        '<span class="material-symbols-outlined text-lg">settings</span> ╨Э╨░╤Б╤В╤А╨╛╨╣╨║╨╕' +
      '</button>' +
    '</nav>' +
    '<div class="mx-2 mt-2 flex items-center justify-between px-3 py-2.5 rounded-xl hover:bg-surface-container-low transition-colors gap-6">' +
      '<div class="flex items-center gap-3">' +
        ...
        '<span class="text-sm font-label text-secondary">╨в╤С╨╝╨╜╨░╤П ╤В╨╡╨╝╨░</span>' +
      '</div>' +
    ...
    '<div class="disk-widget mx-2 mt-4 p-3 bg-surface-container-low rounded-2xl">' +
      '<p class="text-[10px] font-label text-secondary uppercase tracking-widest mb-2 flex items-center gap-1"><span class="material-symbols-outlined text-sm">storage</span> ╨Ф╨╕╤Б╨║</p>' +
      ...
      '</div>' +
      '<p id="disk-text" class="text-[11px] font-label text-secondary">╨Ч╨░╨│╤А╤Г╨╖╨║╨░...</p>' +
    '</div>' +
    '<div class="mt-auto space-y-1 pt-4 border-t border-outline-variant/20">' +
      ...
      '<form method="POST" action="/logout">' +
        '<button type="submit" class="w-full flex items-center gap-3 text-error px-4 py-2.5 hover:bg-red-50 rounded-xl transition-all font-label text-sm">' +
          '<span class="material-symbols-outlined text-lg">logout</span> ╨Т╤Л╨╣╤В╨╕' +
        '</button>' +
      '</form>' +
    '</div>' +
  '</div></aside>' +
  ...
  '<div class="max-w-4xl mx-auto space-y-8 pb-16">' +
    ...
    '<section class="pt-2">' +
      ...
      '<p class="text-secondary font-body text-base leading-relaxed mt-2 mb-8">╨С╤Л╤Б╤В╤А╨░╤П ╨╖╨░╨│╤А╤Г╨╖╨║╨░ ╤Д╨░╨╣╨╗╨╛╨▓ ╨╜╨░ VPS ╨┐╨╛ ╨│╨╕╨│╨░╨▒╨╕╤В╨╜╨╛╨╝╤Г ╨║╨░╨╜╨░╨╗╤Г.</p>' +
      '<div class="relative group">' +
        ...
        '<div class="relative flex items-center p-2 bg-surface-container-lowest rounded-3xl shadow-[0_20px_50px_rgba(107,80,154,0.07)]">' +
          ...
          '<input id="url-input" type="text" class="flex-1 bg-transparent border-none focus:ring-0 text-on-surface font-body py-3.5 text-base placeholder:text-outline" placeholder="╨Т╤Б╤В╨░╨▓╤М╤В╨╡ ╤Б╤Б╤Л╨╗╨║╤Г (HTTP, ╤В╨╛╤А╤А╨╡╨╜╤В, ╨╝╨░╨│╨╜╨╡╤В...)"/>' +
          '<button id="add-btn" onclick="addDownload()" style="font-family:\'Plus Jakarta Sans\',sans-serif;font-weight:700;white-space:nowrap" class="bg-gradient-to-r from-primary to-primary-container text-white px-7 py-3.5 rounded-2xl flex items-center gap-2 hover:opacity-90 active:scale-95 transition-all text-sm">' +
            '<span class="material-symbols-outlined" style="font-size:18px;vertical-align:middle">download</span> ╨б╨║╨░╤З╨░╤В╤М' +
          '</button>' +
        '</div>' +
      '</div>' +
      '<div id="rename-row" class="mt-2 flex items-center gap-2 opacity-0 transition-all duration-200" style="pointer-events:none">' +
        ...
        '<input id="filename-input" type="text" class="flex-1 bg-surface-container-low border border-outline-variant/30 focus:border-primary/40 rounded-xl px-4 py-2.5 text-on-surface font-body text-sm focus:ring-0 placeholder:text-outline outline-none transition-all" placeholder="╨Я╨╡╤А╨╡╨╕╨╝╨╡╨╜╨╛╨▓╨░╤В╤М ╤Д╨░╨╣╨╗ (╨╜╨╡╨╛╨▒╤П╨╖╨░╤В╨╡╨╗╤М╨╜╨╛)"/>' +
      '</div>' +
    '</section>' +
    ...
    '<section id="tab-downloads">' +
      '<div class="flex items-center justify-between mb-5">' +
        '<h3 style="font-family:\'Plus Jakarta Sans\',sans-serif;font-weight:700;font-size:1.125rem;color:#1a1c1f;margin:0">╨Р╨║╤В╨╕╨▓╨╜╤Л╨╡ ╨┐╨╡╤А╨╡╨┤╨░╤З╨╕</h3>' +
        '<button onclick="loadDownloads()" class="px-4 py-2 bg-surface-container-high rounded-full text-xs font-label text-on-secondary-container hover:bg-surface-variant transition-colors flex items-center gap-1">' +
          '<span class="material-symbols-outlined text-base">refresh</span> ╨Ю╨▒╨╜╨╛╨▓╨╕╤В╤М' +
        '</button>' +
      '</div>' +
      '<div id="downloads-list" class="space-y-4"><div class="text-center py-16 text-secondary font-label text-sm">╨Ч╨░╨│╤А╤Г╨╖╨║╨░...</div></div>' +
    '</section>' +

    // Files tab
    '<section id="tab-files" class="hidden">' +
      '<div class="flex items-center justify-between mb-4">' +
        '<h3 style="font-family:\'Plus Jakarta Sans\',sans-serif;font-weight:700;font-size:1.125rem;color:#1a1c1f;margin:0">╨У╨╛╤В╨╛╨▓╤Л╨╡ ╤Д╨░╨╣╨╗╤Л</h3>' +
      ...
      '<div id="upload-zone" onclick="document.getElementById(\'file-input\').click()" class="relative mb-5 border-2 border-dashed border-outline-variant/50 hover:border-primary/50 rounded-3xl p-6 text-center cursor-pointer transition-all duration-200 group">' +
        ...
        '<div class="flex flex-col items-center gap-2 pointer-events-none">' +
          ...
          '<p class="text-sm font-headline font-bold text-secondary group-hover:text-on-surface transition-colors">╨Я╨╡╤А╨╡╤В╨░╤Й╨╕ ╤Д╨░╨╣╨╗╤Л ╨╕╨╗╨╕ ╨╜╨░╨╢╨╝╨╕ ╨┤╨╗╤П ╨▓╤Л╨▒╨╛╤А╨░</p>' +
          '<p class="text-xs font-label text-outline">╨Ы╤О╨▒╤Л╨╡ ╤Д╨░╨╣╨╗╤Л ┬╖ ╨┤╨╛ 500 ╨Ь╨С</p>' +
        '</div>' +
      '</div>' +
      ...
      '<div class="relative mb-4">' +
        ...
        '<input id="file-search" type="text" oninput="filterFiles()" class="w-full bg-surface-container-lowest border border-outline-variant/30 focus:border-primary/40 rounded-2xl pl-11 pr-4 py-3 text-on-surface font-body text-sm focus:ring-0 outline-none transition-all placeholder:text-outline" placeholder="╨Я╨╛╨╕╤Б╨║ ╨┐╨╛ ╨╕╨╝╨╡╨╜╨╕ ╤Д╨░╨╣╨╗╨░..."/>' +
      '</div>' +
      '<div id="files-list" class="space-y-3"><div class="text-center py-16 text-secondary font-label text-sm">╨Ч╨░╨│╤А╤Г╨╖╨║╨░...</div></div>' +
    '</section>' +

    // Shares tab
    '<section id="tab-shares" class="hidden">' +
      '<div class="flex items-center justify-between mb-5">' +
        '<h3 style="font-family:\'Plus Jakarta Sans\',sans-serif;font-weight:700;font-size:1.125rem;color:#1a1c1f;margin:0">╨Я╤Г╨▒╨╗╨╕╤З╨╜╤Л╨╡ ╤Б╤Б╤Л╨╗╨║╨╕</h3>' +
      ...
      '<div class="bg-surface-container-low/60 rounded-2xl px-5 py-3.5 mb-5 text-sm font-label text-secondary flex items-start gap-3">' +
        ...
        '<span>╨б╤Б╤Л╨╗╨║╨╕ ╨┤╨╛╤Б╤В╤Г╨┐╨╜╤Л ╨▒╨╡╨╖ ╨╗╨╛╨│╨╕╨╜╨░ тАФ ╨╝╨╛╨╢╨╜╨╛ ╨┤╨╡╨╗╨╕╤В╤М╤Б╤П ╤Б ╨║╨╡╨╝ ╤Г╨│╨╛╨┤╨╜╨╛. ╨Ф╨╗╤П ╨╛╤В╨╖╤Л╨▓╨░ ╨╜╨░╨╢╨╝╨╕ <b>├Ч</b> ╤А╤П╨┤╨╛╨╝ ╤Б╨╛ ╤Б╤Б╤Л╨╗╨║╨╛╨╣.</span>' +
      '</div>' +
    ...
    '<div class="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">' +
      '<div class="flex items-center justify-between px-6 pt-5 pb-4 border-b border-gray-100">' +
        '<div class="flex items-center gap-3">' +
          ...
          '<div>' +
            '<p style="font-family:Plus Jakarta Sans,sans-serif;font-weight:700;font-size:0.95rem;color:#1a1c1f">VirusTotal ╨Я╤А╨╛╨▓╨╡╤А╨║╨░</p>' +
    ...
    '<div class="bg-white rounded-3xl shadow-2xl w-full max-w-md flex flex-col" style="max-height:82vh">' +
      '<div class="flex items-center justify-between px-6 pt-5 pb-4 border-b border-gray-100 flex-shrink-0">' +
        '<div class="flex items-center gap-3">' +
          ...
          '<p style="font-family:Plus Jakarta Sans,sans-serif;font-weight:700;font-size:0.95rem;color:#1a1c1f">╨Э╨░╤Б╤В╤А╨╛╨╣╨║╨╕</p>' +
        '</div>' +
      ...
      '<div class="p-6 space-y-5 overflow-y-auto">' +
        '<div>' +
          '<p class="font-headline font-bold text-sm text-on-surface mb-2">ЁЯЧС ╨Р╨▓╤В╨╛╤Г╨┤╨░╨╗╨╡╨╜╨╕╨╡ ╤Д╨░╨╣╨╗╨╛╨▓</p>' +
          '<div class="flex gap-3 items-center">' +
            '<select id="retention-select" class="flex-1 bg-surface-container-low text-on-surface border border-outline-variant/30 rounded-xl px-4 py-2.5 text-sm outline-none">' +
              ...
              '<option value="3">3 ╨┤╨╜╤П</option>' +
              '<option value="7">7 ╨┤╨╜╨╡╨╣</option>' +
              '<option value="30">30 ╨┤╨╜╨╡╨╣</option>' +
              '<option value="0">╨Э╨╕╨║╨╛╨│╨┤╨░</option>' +
            '</select>' +
            '<button onclick="saveRetention()" class="px-4 py-2.5 rounded-xl text-sm font-bold text-white transition-all" style="background:#6b509a">╨б╨╛╤Е╤А╨░╨╜╨╕╤В╤М</button>' +
          '</div>' +
        '</div>' +
        '<div class="border-t border-outline-variant/30 pt-5">' +
          '<p class="font-headline font-bold text-sm text-on-surface mb-2">ЁЯФФ ╨г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╤П ╨╛ ╨╖╨░╨│╤А╤Г╨╖╨║╨╡</p>' +
          '<div class="flex gap-3 items-center">' +
            '<p id="notif-status" class="flex-1 text-sm text-secondary"></p>' +
            '<button id="notif-btn" onclick="requestNotifPerm()" class="px-4 py-2.5 rounded-xl text-sm font-bold transition-all bg-surface-container-high text-secondary hover:bg-surface-variant">╨а╨░╨╖╤А╨╡╤И╨╕╤В╤М</button>' +
          '</div>' +
        '</div>' +
        '<div class="border-t border-outline-variant/30 pt-5">' +
          '<p class="font-headline font-bold text-sm text-on-surface mb-2">ЁЯФС ╨б╨╝╨╡╨╜╨╕╤В╤М ╨┐╨░╤А╨╛╨╗╤М</p>' +
          '<div class="space-y-2">' +
            '<input id="pwd-current" type="password" placeholder="╨в╨╡╨║╤Г╤Й╨╕╨╣ ╨┐╨░╤А╨╛╨╗╤М" class="w-full bg-surface-container-low text-on-surface border border-outline-variant/30 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-primary"/>' +
            '<input id="pwd-new" type="password" placeholder="╨Э╨╛╨▓╤Л╨╣ ╨┐╨░╤А╨╛╨╗╤М (╨╝╨╕╨╜. 6 ╤Б╨╕╨╝╨▓╨╛╨╗╨╛╨▓)" class="w-full bg-surface-container-low text-on-surface border border-outline-variant/30 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-primary"/>' +
            '<button onclick="changePassword()" class="w-full px-4 py-2.5 rounded-xl text-sm font-bold text-white transition-all hover:opacity-90" style="background:#6b509a">╨б╨╝╨╡╨╜╨╕╤В╤М ╨┐╨░╤А╨╛╨╗╤М</button>' +
            '<p id="pwd-status" class="text-xs text-center min-h-[16px]"></p>' +
          '</div>' +
        '</div>' +
        (userIsAdmin ?
        '<div class="border-t border-outline-variant/30 pt-5">' +
          '<p class="font-headline font-bold text-sm text-on-surface mb-3">ЁЯСе ╨Я╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╨╕</p>' +
          '<div id="users-list" class="space-y-2 mb-3"></div>' +
          '<div class="bg-surface-container-low rounded-2xl p-3 space-y-2">' +
            '<p class="text-xs font-bold text-secondary uppercase tracking-wider mb-2">╨Ф╨╛╨▒╨░╨▓╨╕╤В╤М ╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤П</p>' +
            '<input id="new-username" type="text" placeholder="╨Ы╨╛╨│╨╕╨╜ (a-z, 0-9, _)" class="w-full bg-white dark:bg-surface-container text-on-surface border border-outline-variant/30 rounded-xl px-3 py-2 text-sm outline-none focus:border-primary"/>' +
            '<input id="new-password" type="password" placeholder="╨Я╨░╤А╨╛╨╗╤М" class="w-full bg-white dark:bg-surface-container text-on-surface border border-outline-variant/30 rounded-xl px-3 py-2 text-sm outline-none focus:border-primary"/>' +
            '<input id="new-label" type="text" placeholder="╨Ю╤В╨╛╨▒╤А╨░╨╢╨░╨╡╨╝╨╛╨╡ ╨╕╨╝╤П (╨╜╨╡╨╛╨▒╤П╨╖╨░╤В╨╡╨╗╤М╨╜╨╛)" class="w-full bg-white dark:bg-surface-container text-on-surface border border-outline-variant/30 rounded-xl px-3 py-2 text-sm outline-none focus:border-primary"/>' +
            '<button onclick="addUser()" class="w-full px-4 py-2 rounded-xl text-sm font-bold text-white transition-all hover:opacity-90" style="background:#6b509a">╨б╨╛╨╖╨┤╨░╤В╤М ╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤П</button>' +
            '<p id="users-status" class="text-xs text-center min-h-[16px]"></p>' +
          '</div>' +
        '</div>'
        : '') +
        '<div class="border-t border-outline-variant/30 pt-5">' +
          '<p class="font-headline font-bold text-sm text-on-surface mb-1">ЁЯзй ╨в╨╛╨║╨╡╨╜ ╨┤╨╗╤П ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П</p>' +
          '<p class="text-xs text-secondary mb-3">╨Т╤Б╤В╨░╨▓╤М╤В╨╡ ╨▓ ╨╜╨░╤Б╤В╤А╨╛╨╣╨║╨╕ ╨▒╤А╨░╤Г╨╖╨╡╤А╨╜╨╛╨│╨╛ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П</p>' +
          '<div id="token-display" class="bg-surface-container-low text-secondary rounded-xl px-4 py-3 text-xs font-mono break-all mb-3" style="line-height:1.6">╨Э╨░╨╢╨╝╨╕╤В╨╡ ┬л╨Я╨╛╨║╨░╨╖╨░╤В╤М┬╗</div>' +
          '<div class="flex gap-2">' +
            '<button onclick="loadMyToken()" class="flex-1 px-3 py-2 bg-surface-container-high text-secondary rounded-xl text-xs font-bold hover:bg-surface-variant transition-colors">╨Я╨╛╨║╨░╨╖╨░╤В╤М</button>' +
            ...
            '<button onclick="resetMyToken()" class="px-3 py-2 rounded-xl text-xs font-bold transition-colors text-error hover:bg-error/10">╨б╨▒╤А╨╛╤Б╨╕╤В╤М</button>' +
          '</div>' +
        '</div>' +
      '</div>' +
    '</div>' +
  ...
  '<div id="notif-banner" class="hidden fixed bottom-6 left-1/2 z-[200]" style="transform:translateX(-50%);width:calc(100% - 320px - 48px);max-width:600px">' +
    '<div class="bg-surface-container-lowest glass shadow-[0_16px_48px_rgba(107,80,154,0.14)] border border-outline-variant/20 rounded-2xl px-5 py-4 flex items-center gap-4">' +
      ...
      '<div class="flex-1 min-w-0">' +
        '<p style="font-family:Plus Jakarta Sans,sans-serif;font-weight:700;font-size:0.875rem;color:#1a1c1f;margin-bottom:2px">╨г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╤П ╨╛ ╨╖╨░╨│╤А╤Г╨╖╨║╨╡</p>' +
        '<p class="text-xs font-label text-secondary">╨г╨╖╨╜╨░╨▓╨░╨╣╤В╨╡ ╤Б╤А╨░╨╖╤Г, ╨║╨╛╨│╨┤╨░ ╤Д╨░╨╣╨╗ ╨┤╨╛╨║╨░╤З╨░╨╗╤Б╤П тАФ ╨┤╨░╨╢╨╡ ╨╡╤Б╨╗╨╕ ╨▓╨║╨╗╨░╨┤╨║╨░ ╤Б╨▓╤С╤А╨╜╤Г╤В╨░</p>' +
      '</div>' +
      '<div class="flex items-center gap-2 flex-shrink-0">' +
        '<button onclick="allowNotif()" class="px-4 py-2 rounded-xl text-sm font-bold text-white transition-all hover:opacity-90 active:scale-95" style="background:linear-gradient(135deg,#6b509a,#a083d1)">╨а╨░╨╖╤А╨╡╤И╨╕╤В╤М</button>' +
  ...
  '  if (!dlUrl) { toast("тЪа ╨Т╨▓╨╡╨┤╨╕╤В╨╡ ╤Б╤Б╤Л╨╗╨║╤Г"); return; }\n' +
  '  var btn = document.getElementById("add-btn");\n' +
  '  btn.disabled = true;\n' +
  '  btn.innerHTML = \'<span class="material-symbols-outlined" style="font-size:18px;vertical-align:middle">hourglass_top</span> ╨Ф╨╛╨▒╨░╨▓╨╗╤П╤О...\';\n' +
  ...
  '      loadDownloads();\n' +
  '    })\n' +
  '    .catch(function(e) { toast("тЬХ " + e.message); })\n' +
  '    .finally(function() {\n' +
  '      btn.disabled = false;\n' +
  '      btn.innerHTML = \'<span class="material-symbols-outlined" style="font-size:18px;vertical-align:middle">download</span> ╨б╨║╨░╤З╨░╤В╤М\';\n' +
  '    });\n' +
  '}\n' +
  '\n' +
  ...
  '    .then(function() { toast("тП╕ ╨Я╨░╤Г╨╖╨░"); loadDownloads(); });\n' +
  '}\n' +
  '\n' +
  'function resumeDownload(gid) {\n' +
  '  fetch("/api/downloads/" + gid + "/resume", { method: "POST" })\n' +
  '    .then(function() { toast("тЦ╢ ╨Т╨╛╨╖╨╛╨▒╨╜╨╛╨▓╨╗╨╡╨╜╨╛"); loadDownloads(); });\n' +
  '}\n' +
  '\n' +
  'function removeDownload(gid) {\n' +
  '  fetch("/api/downloads/" + gid, { method: "DELETE" })\n' +
  '    .then(function() { toast("╨г╨┤╨░╨╗╨╡╨╜╨╛"); loadDownloads(); });\n' +
  '}\n' +
  '\n' +
  'var statusLabel = {active:"╨б╨║╨░╤З╨╕╨▓╨░╨╡╤В╤Б╤П",complete:"╨У╨╛╤В╨╛╨▓╨╛",waiting:"╨Ю╨╢╨╕╨┤╨░╨╜╨╕╨╡",error:"╨Ю╤И╨╕╨▒╨║╨░",paused:"╨Я╨░╤Г╨╖╨░"};\n' +
  ...
  '    if (!data.length) {\n' +
  '      el.innerHTML = \'<div class="text-center py-16"><span class="material-symbols-outlined text-5xl text-outline-variant">cloud_download</span><p class="mt-3 text-secondary font-label text-sm">╨Э╨╡╤В ╨░╨║╤В╨╕╨▓╨╜╤Л╤Е ╨╖╨░╨│╤А╤Г╨╖╨╛╨║</p></div>\';\n' +
  '      return;\n' +
  '    }\n' +
  '    var html = "";\n' +
  ...
  '          \'<button onclick="vtScan(this)" data-name="\' + encodeURIComponent(d.name) + \'" class="opacity-0 group-hover:opacity-100 px-3 py-2 bg-[#394ef5] text-white rounded-full text-xs font-bold flex items-center gap-1 hover:opacity-90 transition-all whitespace-nowrap"><img src="https://www.virustotal.com/gui/images/favicon.png" style="width:14px;height:14px;border-radius:2px"> VT ╨Я╤А╨╛╨▓╨╡╤А╨║╨░</button>\'\n' +
  '        : "";\n' +
  '      var pauseBtn = "";\n' +
  '      if (d.status==="active"||d.status==="waiting") {\n' +
  '        pauseBtn = \'<button onclick="pauseDownload(\\\'\' + d.gid + \'\\\')" class="opacity-0 group-hover:opacity-100 p-2 hover:bg-yellow-50 text-outline hover:text-yellow-600 rounded-full transition-all" title="╨Я╨░╤Г╨╖╨░"><span class="material-symbols-outlined text-lg">pause</span></button>\';\n' +
  '      } else if (d.status==="paused") {\n' +
  '        pauseBtn = \'<button onclick="resumeDownload(\\\'\' + d.gid + \'\\\')" class="p-2 hover:bg-green-50 text-outline hover:text-green-600 rounded-full transition-all" title="╨Т╨╛╨╖╨╛╨▒╨╜╨╛╨▓╨╕╤В╤М"><span class="material-symbols-outlined text-lg">play_arrow</span></button>\';\n' +
  '      }\n' +
  ...
  '        new Notification("тЬУ ╨Ч╨░╨│╤А╤Г╨╖╨║╨░ ╨╖╨░╨▓╨╡╤А╤И╨╡╨╜╨░", { body: d.name });\n' +
  '      } else {\n' +
  '        toast("тЬУ ╨Ч╨░╨│╤А╤Г╨╢╨╡╨╜╨╛: " + d.name);\n' +
  '      }\n' +
  '    }\n' +
  ...
  '        document.getElementById(id + "-pct").textContent = "тЬУ";\n' +
  '        document.getElementById(id + "-pct").style.color = "#16a34a";\n' +
  '        setTimeout(function() { card.remove(); }, 1500);\n' +
  '        loadFiles();\n' +
  '      } else {\n' +
  '        document.getElementById(id + "-pct").textContent = "тЬХ ╨Ю╤И╨╕╨▒╨║╨░";\n' +
  '        document.getElementById(id + "-pct").style.color = "#dc2626";\n' +
  '      }\n' +
  '    });\n' +
  '    xhr.addEventListener("error", function() {\n' +
  '      document.getElementById(id + "-pct").textContent = "тЬХ ╨Ю╤И╨╕╨▒╨║╨░ ╤Б╨╡╤В╨╕";\n' +
  '    });\n' +
  ...
  '  if (!data.length) {\n' +
  '    el.innerHTML = \'<div class="text-center py-16"><span class="material-symbols-outlined text-5xl text-outline-variant">folder_open</span><p class="mt-3 text-secondary font-label text-sm">╨д╨░╨╣╨╗╤Л ╨╜╨╡ ╨╜╨░╨╣╨┤╨╡╨╜╤Л</p></div>\';\n' +
  '    return;\n' +
  '  }\n' +
  '  var html = "";\n' +
  ...
  '    document.getElementById("disk-text").textContent = d.used + " / " + d.total + " тАФ ╤Б╨▓╨╛╨▒╨╛╨┤╨╜╨╛ " + d.avail;\n' +
  '  }).catch(function(){});\n' +
  '}\n' +
  '\n' +
  'function vtScan(btn) {\n' +
  ...
  '  modalBody.innerHTML = \'<div class="flex flex-col items-center py-8 gap-3"><div class="w-8 h-8 border-2 border-[#394ef5] border-t-transparent rounded-full animate-spin"></div><p class="text-sm text-secondary">╨Я╤А╨╛╨▓╨╡╤А╤П╨╡╨╝ ╨▓ VirusTotal...</p></div>\';\n' +
  '  modal.classList.remove("hidden");\n' +
  '  fetch("/api/vt/" + encodeURIComponent(name))\n' +
  '    .then(function(r) { return r.json(); })\n' +
  '    .then(function(d) {\n' +
  '      if (d.error) { modalBody.innerHTML = \'<p class="text-error text-sm p-4">╨Ю╤И╨╕╨▒╨║╨░: \' + d.error + \'</p>\'; return; }\n' +
  ...
  '      var label = bad === 0 ? "╨д╨░╨╣╨╗ ╤З╨╕╤Б╤В╤Л╨╣" : bad <= 3 ? "╨Я╨╛╨┤╨╛╨╖╤А╨╕╤В╨╡╨╗╤М╨╜╤Л╨╣" : "╨Т╤А╨╡╨┤╨╛╨╜╨╛╤Б╨╜╤Л╨╣";\n' +
  '      modalBody.innerHTML =\n' +
  ...
  '            \'<p style="color:#635b6e;font-size:0.75rem;margin-top:4px">╨░╨╜╤В╨╕╨▓╨╕╤А╤Г╤Б╨╛╨▓ ╨╛╨▒╨╜╨░╤А╤Г╨╢╨╕╨╗╨╕ ╤Г╨│╤А╨╛╨╖╤Г</p>\' +\n' +
  '          \'</div>\' +\n' +
  '          \'<div style="display:flex;gap:12px;flex-wrap:wrap;justify-content:center">\' +\n' +
  '            \'<span style="background:#fee2e2;color:#dc2626;padding:4px 12px;border-radius:999px;font-size:0.75rem;font-weight:600">ЁЯжа ╨Т╤А╨╡╨┤╨╛╨╜╨╛╤Б╨╜╤Л╤Е: \' + malicious + \'</span>\' +\n' +
  '            \'<span style="background:#fef3c7;color:#d97706;padding:4px 12px;border-radius:999px;font-size:0.75rem;font-weight:600">тЪая╕П ╨Я╨╛╨┤╨╛╨╖╤А╨╕╤В╨╡╨╗╤М╨╜╤Л╤Е: \' + suspicious + \'</span>\' +\n' +
  '            \'<span style="background:#dcfce7;color:#16a34a;padding:4px 12px;border-radius:999px;font-size:0.75rem;font-weight:600">тЬУ ╨з╨╕╤Б╤В╤Л╤Е: \' + (s.undetected||0) + \'</span>\' +\n' +
  '          \'</div>\' +\n' +
  '          \'<a href="https://www.virustotal.com/gui/file/\' + d.hash + \'" target="_blank" style="color:#394ef5;font-size:0.8rem;text-decoration:underline">╨Ю╤В╨║╤А╤Л╤В╤М ╨┐╨╛╨╗╨╜╤Л╨╣ ╨╛╤В╤З╤С╤В ╨╜╨░ VirusTotal тЖЧ</a>\' +\n' +
  '          (d.cached ? \'<p style="color:#9ca3af;font-size:0.7rem">╨а╨╡╨╖╤Г╨╗╤М╤В╨░╤В ╨╕╨╖ ╨║╤Н╤И╨░ VT</p>\' : \'\') +\n' +
  '        \'</div>\';\n' +
  '    })\n' +
  '    .catch(function(e) { modalBody.innerHTML = \'<p class="text-error text-sm p-4">╨Ю╤И╨╕╨▒╨║╨░: \' + e.message + \'</p>\'; });\n' +
  '}\n' +
  '\n' +
  'function copyToClipboard(text) {\n' +
  '  if (navigator.clipboard && navigator.clipboard.writeText) {\n' +
  '    navigator.clipboard.writeText(text).then(function() {\n' +
  '      toast("ЁЯФЧ ╨б╤Б╤Л╨╗╨║╨░ ╤Б╨║╨╛╨┐╨╕╤А╨╛╨▓╨░╨╜╨░!");\n' +
  '    }).catch(function() { prompt("╨б╨║╨╛╨┐╨╕╤А╤Г╨╣ ╤Б╤Б╤Л╨╗╨║╤Г:", text); });\n' +
  '  } else {\n' +
  ...
  '    ta.focus(); ta.select();\n' +
  '    try { document.execCommand("copy"); toast("ЁЯФЧ ╨б╤Б╤Л╨╗╨║╨░ ╤Б╨║╨╛╨┐╨╕╤А╨╛╨▓╨░╨╜╨░!"); }\n' +
  '    catch(e) { prompt("╨б╨║╨╛╨┐╨╕╤А╤Г╨╣ ╤Б╤Б╤Л╨╗╨║╤Г:", text); }\n' +
  ...
  '    .then(function(r) { return r.json(); })\n' +
  '    .then(function(d) {\n' +
  '      if (d.error) { toast("тЬХ " + d.error); return; }\n' +
  ...
  '    if (!data.length) {\n' +
  '      el.innerHTML = \'<div class="text-center py-16"><span class="material-symbols-outlined text-5xl text-outline-variant">link_off</span><p class="mt-3 text-secondary font-label text-sm">╨Э╨╡╤В ╨░╨║╤В╨╕╨▓╨╜╤Л╤Е ╤Б╤Б╤Л╨╗╨╛╨║</p></div>\';\n' +
  '      return;\n' +
  '    }\n' +
  '    var html = "";\n' +
  ...
  '          \'<button onclick="copyShareUrl(this)" data-url="\' + encodeURIComponent(url) + \'" class="px-3 py-2 bg-surface-container-high text-secondary rounded-full text-xs font-bold flex items-center gap-1 hover:bg-secondary-container transition-all"><span class="material-symbols-outlined text-sm">content_copy</span> ╨Ъ╨╛╨┐╨╕╤А╨╛╨▓╨░╤В╤М</button>\' +\n' +
  '          \'<button onclick="revokeShare(this)" data-token="\' + s.token + \'" class="p-2 text-outline hover:text-error hover:bg-red-50 rounded-full transition-all" title="╨Ю╤В╨╛╨╖╨▓╨░╤В╤М ╤Б╤Б╤Л╨╗╨║╤Г"><span class="material-symbols-outlined text-lg">close</span></button>\' +\n' +
  '        \'</div>\' +\n' +
  '      \'</div>\';\n' +
  '    });\n' +
  '    el.innerHTML = html;\n' +
  ...
  '  if (!confirm("╨Ю╤В╨╛╨╖╨▓╨░╤В╤М ╤Б╤Б╤Л╨╗╨║╤Г? ╨Ю╨╜╨░ ╨┐╨╡╤А╨╡╤Б╤В╨░╨╜╨╡╤В ╤А╨░╨▒╨╛╤В╨░╤В╤М.")) return;\n' +
  '  fetch("/api/share/" + token, { method: "DELETE" })\n' +
  '    .then(function() { toast("тЬУ ╨б╤Б╤Л╨╗╨║╨░ ╨╛╤В╨╛╨╖╨▓╨░╨╜╨░"); loadShares(); });\n' +
  '}\n' +
  '\n' +
  'function deleteFile(btn) {\n' +
  '  var name = decodeURIComponent(btn.dataset.name);\n' +
  '  if (!confirm("╨г╨┤╨░╨╗╨╕╤В╤М " + name + "?")) return;\n' +
  '  fetch("/api/files/" + encodeURIComponent(name), { method: "DELETE" })\n' +
  '    .then(function() { toast("ЁЯЧС ╨г╨┤╨░╨╗╨╡╨╜╨╛"); loadFiles(); });\n' +
  '}\n' +
  '\n' +
  ...
  '    s.textContent = "╨Э╨╡ ╨┐╨╛╨┤╨┤╨╡╤А╨╢╨╕╨▓╨░╨╡╤В╤Б╤П ╨▒╤А╨░╤Г╨╖╨╡╤А╨╛╨╝";\n' +
  '    b.style.display = "none"; return;\n' +
  '  }\n' +
  '  var p = Notification.permission;\n' +
  '  if (p === "granted") {\n' +
  '    s.textContent = "тЬУ ╨Т╨║╨╗╤О╤З╨╡╨╜╤Л";\n' +
  '    s.style.color = "#16a34a";\n' +
  '    b.style.display = "none";\n' +
  '  } else if (p === "denied") {\n' +
  '    s.textContent = "тЬХ ╨Ч╨░╨▒╨╗╨╛╨║╨╕╤А╨╛╨▓╨░╨╜╤Л ╨▓ ╨▒╤А╨░╤Г╨╖╨╡╤А╨╡";\n' +
  '    s.style.color = "#dc2626";\n' +
  '    b.style.display = "none";\n' +
  '  } else {\n' +
  '    s.textContent = "╨Э╨╡ ╤А╨░╨╖╤А╨╡╤И╨╡╨╜╤Л";\n' +
  '    b.style.display = "";\n' +
  '  }\n' +
  '}\n' +
  '\n' +
  'function requestNotifPerm() {\n' +
  '  if (!("Notification" in window)) { toast("╨С╤А╨░╤Г╨╖╨╡╤А ╨╜╨╡ ╨┐╨╛╨┤╨┤╨╡╤А╨╢╨╕╨▓╨░╨╡╤В ╤Г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╤П"); return; }\n' +
  ...
  '    .then(function(r) { return r.json(); })\n' +
  '    .then(function() { toast("тЬУ ╨Р╨▓╤В╨╛╤Г╨┤╨░╨╗╨╡╨╜╨╕╨╡ ╤Б╨╛╤Е╤А╨░╨╜╨╡╨╜╨╛"); });\n' +
  '}\n' +
  '\n' +
  ...
  '  if (t === "╨Э╨░╨╢╨╝╨╕╤В╨╡ ┬л╨Я╨╛╨║╨░╨╖╨░╤В╤М┬╗") { toast("╨б╨╜╨░╤З╨░╨╗╨░ ╨╜╨░╨╢╨╝╨╕ ┬л╨Я╨╛╨║╨░╨╖╨░╤В╤М┬╗"); return; }\n' +
  '  copyToClipboard(t);\n' +
  '}\n' +
  '\n' +
  'function resetMyToken() {\n' +
  '  if (!confirm("╨б╨▒╤А╨╛╤Б╨╕╤В╤М ╤В╨╛╨║╨╡╨╜? ╨б╤В╨░╤А╤Л╨╣ ╨┐╨╡╤А╨╡╤Б╤В╨░╨╜╨╡╤В ╤А╨░╨▒╨╛╤В╨░╤В╤М.")) return;\n' +
  '  fetch("/api/mytoken/reset", { method: "POST" })\n' +
  '    .then(function(r) { return r.json(); })\n' +
  '    .then(function(d) { document.getElementById("token-display").textContent = d.token; toast("тЬУ ╨в╨╛╨║╨╡╨╜ ╨╛╨▒╨╜╨╛╨▓╨╗╤С╨╜"); });\n' +
  '}\n' +
  '\n' +
  ...
  '    dismissNotifBanner();\n' +
  '    if (p === "granted") toast("ЁЯФФ ╨г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╤П ╨▓╨║╨╗╤О╤З╨╡╨╜╤Л!");\n' +
  '    updateNotifStatus();\n' +
  '  });\n' +
  '}\n' +
  '\n' +
  ...
  '  if (!cur || !nw) { st.textContent = "╨Ч╨░╨┐╨╛╨╗╨╜╨╕╤В╨╡ ╨╛╨▒╨░ ╨┐╨╛╨╗╤П"; st.style.color = "#dc2626"; return; }\n' +
  '  var body = new URLSearchParams();\n' +
  ...
  '      else { st.textContent = "тЬУ ╨Я╨░╤А╨╛╨╗╤М ╨╕╨╖╨╝╨╡╨╜╤С╨╜"; st.style.color = "#16a34a";\n' +
  '        document.getElementById("pwd-current").value = "";\n' +
  '        document.getElementById("pwd-new").value = ""; }\n' +
  '    }).catch(function() { st.textContent = "╨Ю╤И╨╕╨▒╨║╨░"; st.style.color = "#dc2626"; });\n' +
  '}\n' +
  '\n' +
  '// тФАтФА ╨г╨┐╤А╨░╨▓╨╗╨╡╨╜╨╕╨╡ ╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤П╨╝╨╕ (admin) тФАтФА\n' +
  'function loadUsers() {\n' +
  ...
  '        \'</div>\' +\n' +
  '        (!u.isAdmin ? \'<button onclick="deleteUser(\\"\' + u.username + \'\\")" class="text-xs text-error hover:bg-red-50 px-2 py-1 rounded-lg transition-colors">╨г╨┤╨░╨╗╨╕╤В╤М</button>\' : \'\') +\n' +
  '      \'</div>\';\n' +
  '    }).join("");\n' +
  '  });\n' +
  '}\n' +
  ...
  '  if (!username || !password) { st.textContent = "╨Ы╨╛╨│╨╕╨╜ ╨╕ ╨┐╨░╤А╨╛╨╗╤М ╨╛╨▒╤П╨╖╨░╤В╨╡╨╗╤М╨╜╤Л"; st.style.color = "#dc2626"; return; }\n' +
  '  var body = new URLSearchParams();\n' +
  ...
  '      if (d.error) { st.textContent = d.error; st.style.color = "#dc2626"; }\n' +
  '      else {\n' +
  '        st.textContent = "тЬУ ╨Я╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤М ╤Б╨╛╨╖╨┤╨░╨╜"; st.style.color = "#16a34a";\n' +
  ...
  '  if (!confirm("╨г╨┤╨░╨╗╨╕╤В╤М ╨┐╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤П @" + username + "? ╨Х╨│╨╛ ╤Д╨░╨╣╨╗╤Л ╨╛╤Б╤В╨░╨╜╤Г╤В╤Б╤П ╨╜╨░ ╤Б╨╡╤А╨▓╨╡╤А╨╡.")) return;\n' +
  '  fetch("/api/users/" + encodeURIComponent(username), { method: "DELETE" })\n' +
  '    .then(function(r) { return r.json(); })\n' +
  '    .then(function(d) {\n' +
  '      if (d.error) { toast("тЬХ " + d.error); }\n' +
  '      else { toast("тЬУ ╨Я╨╛╨╗╤М╨╖╨╛╨▓╨░╤В╨╡╨╗╤М ╨б╤У╨а╥С╨░╨╗╤С╨╜"); loadUsers(); }\n' +
  '    });\n' +
  '}\n' +
  '\n' +
  'function toggleDark() {\n' +
...
function cloudPage(username) { // v3 тАФ multiselect + upload progress + disk fix
  ...
  '<button class="mobile-icon-btn" data-action="focus-search" title="╨Я╨╛╨╕╤Б╨║"><span class="material-symbols-outlined">search</span></button>' +
  '</header>' +
  ...
  '</div>' +
  '<a href="/" class="nav-item"><span class="material-symbols-outlined">arrow_back</span><span>╨У╨╗╨░╨▓╨╜╨░╤П</span></a>' +
  '<div style="font-size:11px;font-weight:600;letter-spacing:.05em;color:#494454;text-transform:uppercase;padding:8px 4px 4px">╨Э╨░╨▓╨╕╨│╨░╤Ж╨╕╤П</div>' +
  '<div class="nav-item active" data-action="nav-dashboard"><span class="material-symbols-outlined">dashboard</span><span>╨У╨╗╨░╨▓╨╜╨░╤П</span></div>' +
  '<div class="nav-item" data-action="nav-files"><span class="material-symbols-outlined">folder</span><span>╨Ь╨╛╨╕ ╤Д╨░╨╣╨╗╤Л</span></div>' +
  '<div class="nav-item" data-action="nav-recent"><span class="material-symbols-outlined">schedule</span><span>╨Э╨╡╨┤╨░╨▓╨╜╨╕╨╡</span></div>' +
  '<div class="nav-item" data-action="nav-url-history"><span class="material-symbols-outlined">history</span><span>╨Ш╤Б╤В╨╛╤А╨╕╤П URL</span></div>' +
  '<div class="nav-item" data-action="nav-settings"><span class="material-symbols-outlined">settings</span><span>╨Э╨░╤Б╤В╤А╨╛╨╣╨║╨╕</span></div>' +
  ...
  '<button class="btn-ghost" data-action="nav-settings" title="╨Я╤А╨╛╤Д╨╕╨╗╤М" style="width:34px;height:34px;min-height:34px;padding:0;display:flex;align-items:center;justify-content:center"><span class="material-symbols-outlined" style="font-size:20px">manage_accounts</span></button>' +
  '</div>' +
  '<div style="display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:10px;padding:7px 9px;border:1px solid rgba(160,120,255,.22);border-radius:10px;background:rgba(14,14,16,.38)"><span style="font-size:10px;color:#958ea0;text-transform:uppercase;letter-spacing:.08em;font-weight:900">╨Т╨╡╤А╤Б╨╕╤П ╤Б╨░╨╣╤В╨░</span><span style="font-size:11px;color:#d2bbff;font-weight:900">v' + SITE_VERSION + '</span></div>' +
  '<div style="display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:6px"><span style="font-size:11px;color:#958ea0">╨Ф╨╕╤Б╨║</span><span style="font-size:11px;color:#cbc3d7" id="disk-label">╨Ч╨░╨│╤А╤Г╨╖╨║╨░...</span></div>' +
  ...
  '<button id="go-back-btn" class="btn-ghost" data-action="go-back" data-drop-path="" title="╨Э╨░╨╖╨░╨┤" style="padding:6px 10px"><span class="material-symbols-outlined">arrow_back</span></button>' +
  ...
  '</div>' +
  '<button class="btn-ghost" data-action="view-list" title="╨б╨┐╨╕╤Б╨╛╨║"><span class="material-symbols-outlined">view_list</span></button>' +
  '<button class="btn-ghost" data-action="view-grid" title="╨б╨╡╤В╨║╨░"><span class="material-symbols-outlined">grid_view</span></button>' +
  '<button class="btn-ghost" data-action="toggle-theme" title="Theme">Theme</button>' +
  '<button class="btn-primary" data-action="upload-btn">╨Ч╨░╨│╤А╤Г╨╖╨╕╤В╤М</button>' +
  '</div>' +
  ...
  '<div style="font-size:16px;color:#ccc3d8;font-weight:700" id="mobile-disk-label">╨Ч╨░╨│╤А╤Г╨╖╨║╨░...</div>' +
  '</div>' +
  ...
  '<button class="btn-ghost" data-action="mkdir"><span class="material-symbols-outlined">create_new_folder</span> ╨Э╨╛╨▓╨░╤П ╨┐╨░╨┐╨║╨░</button>' +
  '</div>' +
  '<div id="selection-bar">' +
  '<div id="selection-count" style="font-size:13px;font-weight:600;color:#d0bcff;flex:1">0 selected</div>' +
  '<button class="btn-ghost" data-action="download-selected">╨б╨║╨░╤З╨░╤В╤М ╨▓╤Б╤С</button>' +
  '<button class="btn-ghost" data-action="zip-selected">╨б╨║╨░╤З╨░╤В╤М ╨░╤А╤Е╨╕╨▓╨╛╨╝</button>' +
  '<button class="btn-ghost" data-action="share-selected">╨Я╤Г╨▒╨╗╨╕╤З╨╜╨░╤П ╤Б╤Б╤Л╨╗╨║╨░</button>' +
  '<button class="btn-ghost" data-action="clear-selection">╨б╨▒╤А╨╛╤Б╨╕╤В╤М</button>' +
  '<button class="btn-ghost" data-action="delete-selected" style="color:#ffb4ab;border-color:#93000a">╨г╨┤╨░╨╗╨╕╤В╤М</button>' +
  '</div>' +
  '<div id="file-scroll" style="flex:1;overflow-y:auto;padding:16px 24px">' +
  '<div id="file-area"><div style="color:#958ea0;padding:40px;text-align:center">╨Ч╨░╨│╤А╤Г╨╖╨║╨░...</div></div>' +
  '</div>' +
  '<div id="transfers-card" class="card">' +
  '<div style="display:flex;align-items:center;gap:10px;margin-bottom:10px"><div style="font-size:13px;font-weight:700;color:#cbc3d7;flex:1">╨Р╨║╤В╨╕╨▓╨╜╤Л╨╡ ╨╖╨░╨│╤А╤Г╨╖╨║╨╕</div><button class="btn-ghost" data-action="minimize-transfers" style="padding:4px 8px" title="╨б╨▓╨╡╤А╨╜╤Г╤В╤М"><span class="material-symbols-outlined">remove</span></button></div>' +
  '<div id="transfers-list"><div style="color:#494454;font-size:13px">╨Э╨╡╤В ╨░╨║╤В╨╕╨▓╨╜╤Л╤Е ╨╖╨░╨│╤А╤Г╨╖╨╛╨║</div></div>' +
  '</div>' +
  '<div id="transfers-chip" data-action="restore-transfers"><span class="material-symbols-outlined">downloading</span><span id="transfers-chip-text">╨Ч╨░╨│╤А╤Г╨╖╨║╨░...</span></div>' +
  '</main>' +
  ...
  '<div id="preview-title" style="font-weight:700;font-size:14px;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">╨Я╤А╨╡╨┤╨┐╤А╨╛╤Б╨╝╨╛╤В╤А</div>' +
  '<button id="preview-btn-prev" class="btn-ghost" data-action="preview-prev" style="padding:5px 9px;display:none" title="╨Я╤А╨╡╨┤╤Л╨┤╤Г╤Й╨╕╨╣"><span class="material-symbols-outlined">navigate_before</span></button>' +
  '<button id="preview-btn-next" class="btn-ghost" data-action="preview-next" style="padding:5px 9px;display:none" title="╨б╨╗╨╡╨┤╤Г╤О╤Й╨╕╨╣"><span class="material-symbols-outlined">navigate_next</span></button>' +
  '<button class="btn-ghost" data-action="fullscreen-preview" style="padding:5px 9px" title="╨Э╨░ ╨▓╨╡╤Б╤М ╤Н╨║╤А╨░╨╜"><span class="material-symbols-outlined">fullscreen</span></button>' +
  '<button class="btn-ghost" data-action="download-preview" style="padding:5px 9px" title="╨б╨║╨░╤З╨░╤В╤М"><span class="material-symbols-outlined">download</span></button>' +
  '<button class="btn-ghost" data-action="share-preview" style="padding:5px 9px" title="╨Я╤Г╨▒╨╗╨╕╤З╨╜╨░╤П ╤Б╤Б╤Л╨╗╨║╨░"><span class="material-symbols-outlined">link</span></button>' +
  '<button class="btn-ghost" data-action="close-preview" style="padding:5px 9px" title="╨Ч╨░╨║╤А╤Л╤В╤М"><span class="material-symbols-outlined">close</span></button>' +
  '</div>' +
  ...
  '<div class="mv-top"><div id="mv-title" class="mv-title">Media</div><button class="mv-icon" data-action="playlist-prev" title="╨Я╤А╨╡╨┤╤Л╨┤╤Г╤Й╨╕╨╣"><span class="material-symbols-outlined">navigate_before</span></button><button class="mv-icon" data-action="playlist-next" title="╨б╨╗╨╡╨┤╤Г╤О╤Й╨╕╨╣"><span class="material-symbols-outlined">navigate_next</span></button><button class="mv-icon" data-action="mv-download" title="╨б╨║╨░╤З╨░╤В╤М"><span class="material-symbols-outlined">download</span></button><button class="mv-icon" data-action="mv-share" title="╨Я╤Г╨▒╨╗╨╕╤З╨╜╨░╤П ╤Б╤Б╤Л╨╗╨║╨░"><span class="material-symbols-outlined">link</span></button><button class="mv-icon" data-action="mv-close" title="╨Ч╨░╨║╤А╤Л╤В╤М"><span class="material-symbols-outlined">close</span></button></div>' +
  ...
  '    <button class="btn-ghost" data-action="copy-toast" style="padding:3px 8px;font-size:11px">ЁЯУЛ</button>' +
  '    <button class="btn-ghost" data-action="hide-toast" style="padding:3px 8px;font-size:11px">тЬХ</button>' +
  '  </div>' +
  '</div>' +

  '<div id="connection-pill"><span class="dot"></span><span id="connection-text">╨Я╤А╨╛╨▓╨╡╤А╤П╤О ╤Б╨╛╨╡╨┤╨╕╨╜╨╡╨╜╨╕╨╡...</span></div>' +

  /* тФАтФА DROP ZONE тФАтФА */
  '<div id="drop-zone">' +
  '<div style="font-size:48px">\u{1F4E5}</div>' +
  '<div style="font-size:20px;font-weight:700;color:#d0bcff">╨Я╨╡╤А╨╡╤В╨░╤Й╨╕╤В╨╡ ╤Д╨░╨╣╨╗╤Л ╨┤╨╗╤П ╨╖╨░╨│╤А╤Г╨╖╨║╨╕</div>' +
  '<div style="font-size:13px;color:#958ea0">╨Ю╤В╨┐╤Г╤Б╤В╨╕╤В╨╡, ╤З╤В╨╛╨▒╤Л ╨╖╨░╨│╤А╤Г╨╖╨╕╤В╤М ╨▓ ╤В╨╡╨║╤Г╤Й╤Г╤О ╨┐╨░╨┐╨║╤Г</div>' +
  '</div>' +

  /* тФАтФА MKDIR MODAL тФАтФА */
  '<div id="upload-panel">' +
  ...
  '<div class="modal">' +
  '<div style="font-weight:700;font-size:18px;margin-bottom:16px">╨Э╨╛╨▓╨░╤П ╨┐╨░╨┐╨║╨░</div>' +
  '<input id="mkdir-name" class="inp" placeholder="╨Э╨░╨╖╨▓╨░╨╜╨╕╨╡ ╨┐╨░╨┐╨║╨╕" style="margin-bottom:16px">' +
  '<div style="display:flex;gap:10px;justify-content:flex-end">' +
  '<button class="btn-ghost" data-action="close-mkdir">╨Ю╤В╨╝╨╡╨╜╨░</button>' +
  '<button class="btn-primary" data-action="confirm-mkdir">╨б╨╛╨╖╨┤╨░╤В╤М</button>' +
  '</div></div></div>' +

  /* тФАтФА RENAME MODAL тФАтФА */
  '<div id="modal-rename" class="modal-backdrop" style="display:none">' +
  '<div class="modal">' +
  '<div style="font-weight:700;font-size:18px;margin-bottom:16px">╨Я╨╡╤А╨╡╨╕╨╝╨╡╨╜╨╛╨▓╨░╤В╤М</div>' +
  ...
  '</div>' +
  '<div style="display:flex;gap:10px;justify-content:flex-end">' +
  '<button class="btn-ghost" data-action="close-rename">╨Ю╤В╨╝╨╡╨╜╨░</button>' +
  '<button class="btn-primary" data-action="confirm-rename">╨б╨╛╤Е╤А╨░╨╜╨╕╤В╤М</button>' +
  '</div></div></div>' +

  '<div id="modal-url" class="modal-backdrop" style="display:none">' +
  '<div class="modal" style="width:460px">' +
  '<div style="font-weight:700;font-size:18px;margin-bottom:6px">╨Ч╨░╨│╤А╤Г╨╖╨╕╤В╤М ╨┐╨╛ URL</div>' +
  '<div style="font-size:12px;color:#958ea0;margin-bottom:14px">╨д╨░╨╣╨╗ ╨┐╨╛╨┐╨░╨┤╤С╤В ╨▓ ╤В╨╡╨║╤Г╤Й╤Г╤О ╨┐╨░╨┐╨║╤Г CloudSpace</div>' +
  '<input id="url-dl-inp" class="inp" placeholder="https://example.com/file.zip" style="margin-bottom:10px">' +
  '<select id="url-mode-inp" class="inp" style="margin-bottom:10px"><option value="file">╨Ю╨▒╤Л╤З╨╜╤Л╨╣ ╤Д╨░╨╣╨╗</option><option value="video">╨Ь╨╡╨┤╨╕╨░: ╨▓╨╕╨┤╨╡╨╛</option><option value="audio">╨Ь╨╡╨┤╨╕╨░: MP3 audio</option><option value="best">╨Ь╨╡╨┤╨╕╨░: ╨╗╤Г╤З╤И╨╕╨╣ ╨┤╨╛╤Б╤В╤Г╨┐╨╜╤Л╨╣ ╤Д╨░╨╣╨╗</option></select>' +
  '<input id="url-name-inp" class="inp" placeholder="╨Ш╨╝╤П ╨▒╨╡╨╖ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П, ╨╡╤Б╨╗╨╕ ╨╜╤Г╨╢╨╜╨╛" style="margin-bottom:6px">' +
  '<div id="url-name-hint" style="font-size:11px;color:#958ea0;margin-bottom:12px">╨Ф╨╗╤П ╨╝╨╡╨┤╨╕╨░ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╨╡ ╨┤╨╛╨▒╨░╨▓╨╕╤В╤Б╤П ╨░╨▓╤В╨╛╨╝╨░╤В╨╕╤З╨╡╤Б╨║╨╕: .mp4 ╨╕╨╗╨╕ .mp3</div>' +
  '<div id="url-status" style="font-size:12px;color:#958ea0;min-height:16px;margin-bottom:12px"></div>' +
  '<div style="display:flex;gap:10px;justify-content:flex-end">' +
  '<button class="btn-ghost" data-action="close-url-modal">╨Ю╤В╨╝╨╡╨╜╨░</button>' +
  '<button class="btn-primary" data-action="confirm-url-download">╨Ч╨░╨│╤А╤Г╨╖╨╕╤В╤М</button>' +
  '</div></div></div>' +

  '<div id="modal-share" class="modal-backdrop" style="display:none">' +
  '<div class="modal" style="width:460px">' +
  '<div style="font-weight:700;font-size:18px;margin-bottom:6px">╨Я╤Г╨▒╨╗╨╕╤З╨╜╨░╤П ╤Б╤Б╤Л╨╗╨║╨░</div>' +
  '<div id="share-target-label" style="font-size:12px;color:#958ea0;margin-bottom:14px">╨Э╨░╤Б╤В╤А╨╛╨╣╨║╨╕ ╨┤╨╛╤Б╤В╤Г╨┐╨░</div>' +
  '<label style="display:block;font-size:12px;color:#958ea0;margin-bottom:6px">╨б╤А╨╛╨║ ╨┤╨╡╨╣╤Б╤В╨▓╨╕╤П</label>' +
  '<select id="share-expire-inp" class="inp" style="margin-bottom:12px">' +
  '<option value="0">╨С╨╡╨╖ ╨╛╨│╤А╨░╨╜╨╕╤З╨╡╨╜╨╕╤П</option><option value="1">1 ╤З╨░╤Б</option><option value="24">1 ╨┤╨╡╨╜╤М</option><option value="72">3 ╨┤╨╜╤П</option><option value="168">7 ╨┤╨╜╨╡╨╣</option><option value="720">30 ╨┤╨╜╨╡╨╣</option>' +
  '</select>' +
  '<label style="display:block;font-size:12px;color:#958ea0;margin-bottom:6px">╨Ъ╨╛╨╗╨╕╤З╨╡╤Б╤В╨▓╨╛ ╤Б╨║╨░╤З╨╕╨▓╨░╨╜╨╕╨╣</label>' +
  '<input id="share-max-inp" class="inp" type="number" min="0" step="1" placeholder="0 = ╨▒╨╡╨╖ ╨╛╨│╤А╨░╨╜╨╕╤З╨╡╨╜╨╕╤П" style="margin-bottom:12px">' +
  '<label style="display:block;font-size:12px;color:#958ea0;margin-bottom:6px">╨Я╨░╤А╨╛╨╗╤М ╨┤╨╗╤П ╨╖╨░╤Й╨╕╤В╤Л ╤Б╤Б╤Л╨╗╨║╨╕ (╨╛╨┐╤Ж╨╕╨╛╨╜╨░╨╗╤М╨╜╨╛)</label>' +
  '<input id="share-password-inp" class="inp" type="password" placeholder="╨Ю╤Б╤В╨░╨▓╤М╤В╨╡ ╨┐╤Г╤Б╤В╤Л╨╝, ╨╡╤Б╨╗╨╕ ╨┐╨░╤А╨╛╨╗╤М ╨╜╨╡ ╨╜╤Г╨╢╨╡╨╜" style="margin-bottom:12px">' +
  '<label style="display:flex;align-items:center;gap:8px;font-size:12px;color:#958ea0;margin-bottom:12px;cursor:pointer">' +
  '<input type="checkbox" id="share-preview-chk" checked style="cursor:pointer"> ╨б╨╛╨╖╨┤╨░╤В╤М ╤Б╤В╤А╨░╨╜╨╕╤Ж╤Г ╨┐╤А╨╡╨┤╨┐╤А╨╛╤Б╨╝╨╛╤В╤А╨░ (╨▓╨╝╨╡╤Б╤В╨╛ ╨░╨▓╤В╨╛-╤Б╨║╨░╤З╨╕╨▓╨░╨╜╨╕╤П)' +
  '</label>' +
  '<div id="share-status" style="font-size:12px;color:#958ea0;min-height:16px;margin-bottom:12px"></div>' +
  '<div style="display:flex;gap:10px;justify-content:flex-end">' +
  '<button class="btn-ghost" data-action="close-share-modal">╨Ю╤В╨╝╨╡╨╜╨░</button>' +
  '<button class="btn-primary" data-action="confirm-share">╨б╨╛╨╖╨┤╨░╤В╤М ╤Б╤Б╤Л╨╗╨║╤Г</button>' +
  '</div></div></div>' +

  '<div id="modal-qr" class="modal-backdrop" style="display:none">' +
  '<div class="modal" style="width:380px;text-align:center">' +
  '<div style="font-weight:700;font-size:18px;margin-bottom:6px">QR-╨║╨╛╨┤ ╤Б╤Б╤Л╨╗╨║╨╕</div>' +
  ...
  '<a id="qr-open-link" class="btn-ghost" target="_blank" rel="noopener" style="text-decoration:none">╨Ю╤В╨║╤А╤Л╤В╤М</a>' +
  '<button class="btn-ghost" data-action="copy-toast">╨Ъ╨╛╨┐╨╕╤А╨╛╨▓╨░╤В╤М</button>' +
  '<button class="btn-primary" data-action="close-qr">╨У╨╛╤В╨╛╨▓╨╛</button>' +
  '</div></div></div>' +
  ...
  '<div style="flex:1"><div style="font-weight:800;font-size:18px;margin-bottom:4px">╨Я╤Г╨▒╨╗╨╕╤З╨╜╤Л╨╡ ╤Б╤Б╤Л╨╗╨║╨╕</div><div id="sm-file-label" style="font-size:12px;color:#958ea0;word-break:break-all"></div></div>' +
  ...
  '<div style="font-weight:700;font-size:14px;margin-bottom:10px">╨б╨╛╨╖╨┤╨░╤В╤М ╨╜╨╛╨▓╤Г╤О ╤Б╤Б╤Л╨╗╨║╤Г</div>' +
  '<div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px">' +
  '<select id="sm-new-expire" class="inp"><option value="0">╨С╨╡╨╖ ╨╛╨│╤А╨░╨╜╨╕╤З╨╡╨╜╨╕╤П</option><option value="1">1 ╤З╨░╤Б</option><option value="24">1 ╨┤╨╡╨╜╤М</option><option value="72">3 ╨┤╨╜╤П</option><option value="168">7 ╨┤╨╜╨╡╨╣</option><option value="720">30 ╨┤╨╜╨╡╨╣</option></select>' +
  '<input id="sm-new-max" class="inp" type="number" min="0" step="1" placeholder="╨б╨║╨░╤З╨╕╨▓╨░╨╜╨╕╨╣: 0 = ╨▒╨╡╨╖ ╨╗╨╕╨╝╨╕╤В╨░">' +
  '</div>' +
  '<div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px">' +
  '<input id="sm-new-password" class="inp" type="password" placeholder="╨Я╨░╤А╨╛╨╗╤М (╨╛╨┐╤Ж╨╕╨╛╨╜╨░╨╗╤М╨╜╨╛)">' +
  '<label style="display:flex;align-items:center;gap:8px;font-size:12px;color:#958ea0;cursor:pointer"><input type="checkbox" id="sm-new-preview" checked> ╨б╤В╤А╨░╨╜╨╕╤Ж╨░ ╨┐╤А╨╡╨┤╨┐╤А╨╛╤Б╨╝╨╛╤В╤А╨░</label>' +
  '</div>' +
  '<div style="display:flex;justify-content:flex-end;margin-top:10px"><button class="btn-primary" data-action="sm-create"><span class="material-symbols-outlined">add_link</span> ╨б╨╛╨╖╨┤╨░╤В╤М ╤Б╤Б╤Л╨╗╨║╤Г</button></div>' +
  '</div>' +
  '</div></div>' +
  ...
  'function updateSelectionBar(){var n=selectedList().length;document.getElementById("selection-count").textContent="╨Т╤Л╨▒╤А╨░╨╜╨╛: "+n;document.getElementById("selection-bar").style.display=n?"flex":"none";}' +
  ...
  'function copyToast(){if(toastUrl&&navigator.clipboard)navigator.clipboard.writeText(toastUrl).then(function(){showToast("╨б╨║╨╛╨┐╨╕╤А╨╛╨▓╨░╨╜╨╛",toastUrl,toastUrl);});}' +
  ...
  'function copyOrShowLink(url){var full=window.location.origin+url;showToast("╨Я╤Г╨▒╨╗╨╕╤З╨╜╨░╤П ╤Б╤Б╤Л╨╗╨║╨░ ╨│╨╛╤В╨╛╨▓╨░",full,full);}' +
  ...
  'function notifyDone(name){playDoneSound();showToast("╨Ч╨░╨│╤А╤Г╨╖╨║╨░ ╨╖╨░╨▓╨╡╤А╤И╨╡╨╜╨░",name||"╨д╨░╨╣╨╗ ╨│╨╛╤В╨╛╨▓","");if("Notification" in window){if(Notification.permission==="granted")new Notification("CloudSpace: ╨╖╨░╨│╤А╤Г╨╖╨║╨░ ╨╖╨░╨▓╨╡╤А╤И╨╡╨╜╨░",{body:name||"╨д╨░╨╣╨╗ ╨│╨╛╤В╨╛╨▓"});else if(Notification.permission==="default")Notification.requestPermission().then(function(p){if(p==="granted")new Notification("CloudSpace: ╨╖╨░╨│╤А╤Г╨╖╨║╨░ ╨╖╨░╨▓╨╡╤А╤И╨╡╨╜╨░",{body:name||"╨д╨░╨╣╨╗ ╨│╨╛╤В╨╛╨▓"});});}}' +
  'function notifyFail(name,error){showToast("╨Ч╨░╨│╤А╤Г╨╖╨║╨░ ╨╜╨╡ ╤Г╨┤╨░╨╗╨░╤Б╤М",(name||"Media download")+(error?": "+error:""),"");if("Notification" in window){if(Notification.permission==="granted")new Notification("CloudSpace: ╨╖╨░╨│╤А╤Г╨╖╨║╨░ ╨╜╨╡ ╤Г╨┤╨░╨╗╨░╤Б╤М",{body:(name||"Media download")+(error?": "+error:"")});else if(Notification.permission==="default")Notification.requestPermission().then(function(p){if(p==="granted")new Notification("CloudSpace: ╨╖╨░╨│╤А╤Г╨╖╨║╨░ ╨╜╨╡ ╤Г╨┤╨░╨╗╨░╤Б╤М",{body:(name||"Media download")+(error?": "+error:"")});});}}' +
  ...
  'function openShareModal(payload,label){pendingShare=payload;document.getElementById("share-target-label").textContent=label||"╨Э╨░╤Б╤В╤А╨╛╨╣╨║╨╕ ╨┤╨╛╤Б╤В╤Г╨┐╨░";document.getElementById("share-expire-inp").value="0";document.getElementById("share-max-inp").value="";document.getElementById("share-password-inp").value="";document.getElementById("share-preview-chk").checked=true;document.getElementById("share-status").textContent="";document.getElementById("modal-share").style.display="flex";}' +
  'function closeShareModal(){document.getElementById("modal-share").style.display="none";pendingShare=null;}' +
  'function confirmShare(){if(!pendingShare)return;var body=Object.assign({},pendingShare);body.expiresIn=parseInt(document.getElementById("share-expire-inp").value||"0",10);body.maxDownloads=parseInt(document.getElementById("share-max-inp").value||"0",10);body.password=document.getElementById("share-password-inp").value.trim();body.preview=document.getElementById("share-preview-chk").checked;var st=document.getElementById("share-status");st.textContent="╨б╨╛╨╖╨┤╨░╤О ╤Б╤Б╤Л╨╗╨║╤Г...";fetch("/api/fm/share",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(body)}).then(function(r){return r.json();}).then(function(d){if(d.ok){closeShareModal();copyOrShowLink(d.url);if(previewFp)renderPreviewInfo(previewFp,previewName);}else st.textContent=d.error||"╨Ю╤И╨╕╨▒╨║╨░ ╤Б╤Б╤Л╨╗╨║╨╕";}).catch(function(){st.textContent="╨Ю╤И╨╕╨▒╨║╨░ ╤Б╤Б╤Л╨╗╨║╨╕";});}' +
  'function shareSelected(){var items=selectedPayload();if(!items.length)return;openShareModal({items:items},"╨Т╤Л╨▒╤А╨░╨╜╨╛ ╨╛╨▒╤К╨╡╨║╤В╨╛╨▓: "+items.length);}' +
  'function shareOne(fp){openShareModal({path:fp},"╨Ю╨▒╤К╨╡╨║╤В: "+fp);}' +
  'function shareExpireOptions(selected){var opts=[[0,"╨С╨╡╨╖ ╨╛╨│╤А╨░╨╜╨╕╤З╨╡╨╜╨╕╤П"],[1,"1 ╤З╨░╤Б"],[24,"1 ╨┤╨╡╨╜╤М"],[72,"3 ╨┤╨╜╤П"],[168,"7 ╨┤╨╜╨╡╨╣"],[720,"30 ╨┤╨╜╨╡╨╣"]];return opts.map(function(o){return "<option value=\\""+o[0]+"\\""+(String(selected)===String(o[0])?" selected":"")+">"+o[1]+"</option>";}).join("");}' +
  'function shareDateText(v){return v?fmtDateTime(v):"╨С╨╡╨╖ ╨╛╨│╤А╨░╨╜╨╕╤З╨╡╨╜╨╕╤П";}' +
  'function shareMaxText(v){return v?String(v):"╨С╨╡╨╖ ╨╗╨╕╨╝╨╕╤В╨░";}' +
  ...
  'function renderShareManager(items){var box=document.getElementById("sm-list");if(!items.length){box.innerHTML=\'<div class="card" style="padding:14px;margin:0;color:#958ea0">╨г ╤Н╤В╨╛╨│╨╛ ╤Д╨░╨╣╨╗╨░ ╨┐╨╛╨║╨░ ╨╜╨╡╤В ╨┐╤Г╨▒╨╗╨╕╤З╨╜╤Л╤Е ╤Б╤Б╤Л╨╗╨╛╨║.</div>\';return;}var h="";items.forEach(function(x){var full=window.location.origin+x.url;var lockIcon=x.hasPassword?"\u{1F512}":"\u{1F513}";h+=\'<div class="card" style="padding:14px;margin:0 0 10px 0"><div style="display:flex;gap:10px;align-items:flex-start;margin-bottom:10px"><div style="flex:1;min-width:0"><div style="font-size:12px;color:#958ea0;margin-bottom:4px">╨б╨╛╨╖╨┤╨░╨╜╨░: \'+H(fmtDateTime(x.created))+\'; ╨┤╨╡╨╣╤Б╤В╨▓╤Г╨╡╤В ╨┤╨╛: \'+H(shareDateText(x.expiresAt))+\' &middot; \'+lockIcon+\'</div><div style="font-size:12px;color:#d2bbff;word-break:break-all">\'+H(full)+\'</div><div style="font-size:12px;color:#958ea0;margin-top:4px">╨б╨║╨░╤З╨╕╨▓╨░╨╜╨╕╨╣: \'+H(String(x.downloads||0))+\' / \'+H(shareMaxText(x.maxDownloads))+\'</div></div><button class="btn-ghost" data-action="sm-qr" data-url="\'+H(full)+\'" style="padding:6px 9px"><span class="material-symbols-outlined">qr_code_2</span></button><button class="btn-ghost" data-action="sm-copy" data-url="\'+H(full)+\'" style="padding:6px 9px"><span class="material-symbols-outlined">content_copy</span></button></div><div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px"><select id="sm-expire-\'+H(x.token)+\'" class="inp">\'+shareExpireOptions(0)+\'</select><input id="sm-max-\'+H(x.token)+\'" class="inp" type="number" min="0" step="1" value="\'+H(x.maxDownloads||"")+\'" placeholder="0 = ╨▒╨╡╨╖ ╨╗╨╕╨╝╨╕╤В╨░"></div><div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px"><input id="sm-password-\'+H(x.token)+\'" class="inp" type="password" placeholder="╨Э╨╛╨▓╤Л╨╣ ╨┐╨░╤А╨╛╨╗╤М"><label style="display:flex;align-items:center;gap:6px;font-size:12px;color:#958ea0;cursor:pointer"><input type="checkbox" id="sm-clear-password-\'+H(x.token)+\'"> ╨б╨▒╤А╨╛╤Б╨╕╤В╤М ╨┐╨░╤А╨╛╨╗╤М</label></div><label style="display:flex;align-items:center;gap:8px;font-size:12px;color:#958ea0;margin-bottom:10px"><input type="checkbox" id="sm-preview-\'+H(x.token)+\'" \'+(x.preview!==false?"checked":"")+\' > ╨б╤В╤А╨░╨╜╨╕╤Ж╨░ ╨┐╤А╨╡╨┤╨┐╤А╨╛╤Б╨╝╨╛╤В╤А╨░</label><div style="display:flex;gap:8px;justify-content:flex-end"><button class="btn-ghost" data-action="sm-save" data-token="\'+H(x.token)+\'">╨б╨╛╤Е╤А╨░╨╜╨╕╤В╤М</button><button class="btn-ghost" data-action="sm-revoke" data-token="\'+H(x.token)+\'" style="color:#ffb4ab;border-color:#93000a">╨Ю╤В╨╛╨╖╨▓╨░╤В╤М</button></div></div>\';});box.innerHTML=h;}' +
  'function loadShareManager(){if(!shareManagerFp)return;document.getElementById("sm-status").textContent="╨Ч╨░╨│╤А╤Г╨╢╨░╤О ╤Б╤Б╤Л╨╗╨║╨╕...";fetch("/api/fm/shares?path="+encodeURIComponent(shareManagerFp)).then(function(r){return r.json();}).then(function(d){if(!d.ok){document.getElementById("sm-status").textContent=d.error||"╨Ю╤И╨╕╨▒╨║╨░";return;}document.getElementById("sm-status").textContent="";renderShareManager(d.shares||[]);}).catch(function(){document.getElementById("sm-status").textContent="╨Ю╤И╨╕╨▒╨║╨░ ╨╖╨░╨│╤А╤Г╨╖╨║╨╕ ╤Б╤Б╤Л╨╗╨╛╨║";});}' +
  'function createManagedShare(){if(!shareManagerFp)return;var body={path:shareManagerFp,expiresIn:parseInt(document.getElementById("sm-new-expire").value||"0",10),maxDownloads:parseInt(document.getElementById("sm-new-max").value||"0",10),password:document.getElementById("sm-new-password").value.trim(),preview:document.getElementById("sm-new-preview").checked};document.getElementById("sm-status").textContent="╨б╨╛╨╖╨┤╨░╤О ╤Б╤Б╤Л╨╗╨║╤Г...";fetch("/api/fm/share",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(body)}).then(function(r){return r.json();}).then(function(d){if(d.ok){document.getElementById("sm-new-expire").value="0";document.getElementById("sm-new-max").value="";document.getElementById("sm-new-password").value="";document.getElementById("sm-new-preview").checked=true;copyOrShowLink(d.url);loadShareManager();if(previewFp===shareManagerFp)renderPreviewInfo(previewFp,previewName);}else document.getElementById("sm-status").textContent=d.error||"╨Ю╤И╨╕╨▒╨║╨░ ╤Б╤Б╤Л╨╗╨║╨╕";}).catch(function(){document.getElementById("sm-status").textContent="╨Ю╤И╨╕╨▒╨║╨░ ╤Б╤Б╤Л╨╗╨║╨╕";});}' +
  'function saveManagedShare(token){var clearChecked=!!(document.getElementById("sm-clear-password-"+token)||{}).checked;var passVal=(document.getElementById("sm-password-"+token)||{}).value||"";var body={expiresIn:parseInt((document.getElementById("sm-expire-"+token)||{}).value||"0",10),maxDownloads:parseInt((document.getElementById("sm-max-"+token)||{}).value||"0",10),preview:!!(document.getElementById("sm-preview-"+token)||{}).checked};if(clearChecked)body.password="";else if(passVal.trim())body.password=passVal.trim();document.getElementById("sm-status").textContent="╨б╨╛╤Е╤А╨░╨╜╤П╤О...";fetch("/api/fm/share/"+encodeURIComponent(token),{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(body)}).then(function(r){return r.json();}).then(function(d){document.getElementById("sm-status").textContent=d.ok?"╨б╨╛╤Е╤А╨░╨╜╨╡╨╜╨╛":(d.error||"╨Ю╤И╨╕╨▒╨║╨░");loadShareManager();if(previewFp===shareManagerFp)renderPreviewInfo(previewFp,previewName);}).catch(function(){document.getElementById("sm-status").textContent="╨Ю╤И╨╕╨▒╨║╨░ ╤Б╨╛╤Е╤А╨░╨╜╨╡╨╜╨╕╤П";});}' +
  'function revokeManagedShare(token){if(!confirm("╨Ю╤В╨╛╨╖╨▓╨░╤В╤М ╤Н╤В╤Г ╨┐╤Г╨▒╨╗╨╕╤З╨╜╤Г╤О ╤Б╤Б╤Л╨╗╨║╤Г?"))return;fetch("/api/share/"+encodeURIComponent(token),{method:"DELETE"}).then(function(r){return r.json();}).then(function(d){if(!d.ok)throw new Error(d.error||"╨Ю╤И╨╕╨▒╨║╨░");loadShareManager();if(previewFp===shareManagerFp)renderPreviewInfo(previewFp,previewName);}).catch(function(e){document.getElementById("sm-status").textContent=e.message;});}' +
  'function copyPlain(url){if(navigator.clipboard)navigator.clipboard.writeText(url).then(function(){showToast("╨б╨║╨╛╨┐╨╕╤А╨╛╨▓╨░╨╜╨╛",url,url);});}' +

  /* тФАтФА BREADCRUMB тФАтФА */
  ...
  '  var html=\'<span data-action="navigate" data-drop-path="" data-fp="" style="color:#a078ff;cursor:pointer;font-weight:600">╨Ь╨╛╨╕ ╤Д╨░╨╣╨╗╤Л</span>\';' +
  '  var built="";' +
  ...
  '  document.getElementById("file-area").innerHTML=\'<div style="color:#958ea0;padding:40px;text-align:center">╨Ч╨░╨│╤А╤Г╨╖╨║╨░...</div>\';' +
  ...
  '  })' +
  '  .catch(function(){document.getElementById("file-area").innerHTML=\'<div style="color:#ffb4ab;padding:24px">╨Ю╤И╨╕╨▒╨║╨░ ╨╖╨░╨│╤А╤Г╨╖╨║╨╕</div>\';});' +
  '}' +
  ...
  "  var bc=document.getElementById(\"breadcrumb\");if(bc)bc.innerHTML='<span style=\"color:#a078ff;font-weight:800\">CloudSpace</span><span class=\"breadcrumb-sep\">/</span><span>╨У╨╗╨░╨▓╨╜╨░╤П</span>';" +
  "  var h='';" +
  ...
  "  h+='<div style=\"display:flex;align-items:center;gap:10px;margin-bottom:20px;color:#d7c7ff;font-size:12px;font-weight:900;text-transform:uppercase;letter-spacing:.08em\"><span class=\"material-symbols-outlined\">bolt</span> ╨С╤Л╤Б╤В╤А╨░╤П ╨╛╤В╨┐╤А╨░╨▓╨║╨░ ╨╜╨░ VPS</div>';" +
  "  h+='<h1 style=\"font-size:34px;line-height:1.08;margin:0 0 10px;color:#fff;font-weight:900;max-width:760px\">╨б╨║╨░╤З╨░╨╣ ╤Д╨░╨╣╨╗ ╨╜╨░ ╤Б╨╡╤А╨▓╨╡╤А ╨╕ ╨╖╨░╨▒╨╡╤А╨╕ ╤Б ╨╗╤О╨▒╨╛╨│╨╛ ╤Г╤Б╤В╤А╨╛╨╣╤Б╤В╨▓╨░</h1>';" +
  "  h+='<div style=\"color:#bfb5d6;font-size:14px;line-height:1.55;max-width:780px;margin-bottom:22px\">╨Т╤Б╤В╨░╨▓╤М ╤Б╤Б╤Л╨╗╨║╤Г, ╨▓╤Л╨▒╨╡╤А╨╕ ╤А╨╡╨╢╨╕╨╝ ╨╕╨╗╨╕ ╨╖╨░╨║╨╕╨╜╤М ╤Д╨░╨╣╨╗ ╤Б ╨║╨╛╨╝╨┐╤М╤О╤В╨╡╤А╨░. ╨Т╤Б╤С ╨┐╨╛╨┐╨░╨┤╤С╤В ╨▓ CloudSpace, ╨▒╨╡╨╖ ╨┐╤А╤Л╨╢╨║╨╛╨▓ ╨╝╨╡╨╢╨┤╤Г ╨▓╨║╨╗╨░╨┤╨║╨░╨╝╨╕.</div>';" +
  "  h+='<div style=\"display:grid;grid-template-columns:minmax(0,1fr) 170px;gap:10px;margin-bottom:10px\"><input id=\"dash-url-inp\" class=\"inp\" placeholder=\"https://example.com/file.zip ╨╕╨╗╨╕ ╤Б╤Б╤Л╨╗╨║╨░ ╨╜╨░ ╨▓╨╕╨┤╨╡╨╛\"><select id=\"dash-mode-inp\" class=\"inp\"><option value=\"file\">╨Ю╨▒╤Л╤З╨╜╤Л╨╣ ╤Д╨░╨╣╨╗</option><option value=\"video\">╨Т╨╕╨┤╨╡╨╛</option><option value=\"audio\">MP3 audio</option><option value=\"best\">╨Ы╤Г╤З╤И╨╕╨╣ ╤Д╨░╨╣╨╗</option></select></div>';" +
  "  h+='<div style=\"display:grid;grid-template-columns:minmax(0,1fr) auto auto;gap:10px;align-items:center\"><input id=\"dash-name-inp\" class=\"inp\" placeholder=\"╨Ш╨╝╤П ╨▒╨╡╨╖ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П, ╨╡╤Б╨╗╨╕ ╨╜╤Г╨╢╨╜╨╛\"><button class=\"btn-primary\" data-action=\"dashboard-url-download\"><span class=\"material-symbols-outlined\">download</span> ╨Ч╨░╨│╤А╤Г╨╖╨╕╤В╤М</button><button class=\"btn-ghost\" data-action=\"upload-btn\"><span class=\"material-symbols-outlined\">upload_file</span> ╨б ╨Я╨Ъ</button></div>';" +
  ...
  "  h+='<div class=\"card\" data-action=\"nav-files\" style=\"margin:0;padding:22px;cursor:pointer;border-radius:24px;background:linear-gradient(180deg,#1d1d21,#17171a);min-height:150px\"><div style=\"display:flex;align-items:center;justify-content:space-between;gap:12px\"><span class=\"material-symbols-outlined\" style=\"font-size:36px;color:#9ddcff\">folder_open</span><span class=\"material-symbols-outlined\" style=\"color:#958ea0\">arrow_forward</span></div><div style=\"font-size:22px;font-weight:900;color:#fff;margin-top:22px\">╨Ь╨╛╨╕ ╤Д╨░╨╣╨╗╤Л</div><div id=\"dash-files-meta\" style=\"font-size:13px;color:#a9a1b8;margin-top:6px\">╨б╤З╨╕╤В╨░╤О ╤Е╤А╨░╨╜╨╕╨╗╨╕╤Й╨╡...</div></div>';" +
  "  h+='<div class=\"card\" style=\"margin:0;padding:22px;border-radius:24px;background:linear-gradient(180deg,#191d1a,#151716)\"><div style=\"font-size:12px;color:#8ff0a4;font-weight:900;text-transform:uppercase;letter-spacing:.08em;margin-bottom:14px\">╨Ф╨╕╤Б╨║</div><div style=\"display:flex;align-items:flex-end;justify-content:space-between;gap:12px\"><div id=\"dash-disk-big\" style=\"font-size:30px;font-weight:900;color:#fff\">...</div><div id=\"dash-disk-small\" style=\"font-size:12px;color:#a9a1b8;text-align:right\">╨Ч╨░╨│╤А╤Г╨╖╨║╨░</div></div><div class=\"disk-bar\" style=\"margin-top:18px;height:8px\"><div class=\"disk-fill\" id=\"dash-disk-fill\" style=\"width:0%\"></div></div></div>';" +
  "  h+='</div>';" +
  "  h+='</section>';" +
  "  h+='<section style=\"display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-top:18px\">';" +
  "  h+=dashActionCard(\"history\",\"╨Ш╤Б╤В╨╛╤А╨╕╤П URL\",\"╨Я╨╛╨▓╤В╨╛╤А╤Л ╨╕ ╨╝╨╡╨┤╨╕╨░-╨╖╨░╨┤╨░╤З╨╕\",\"nav-url-history\",\"#ffd166\");" +
  "  h+=dashActionCard(\"settings\",\"╨Э╨░╤Б╤В╤А╨╛╨╣╨║╨╕\",\"╨Я╨░╤А╨╛╨╗╤М, ╤В╨╛╨║╨╡╨╜, ╨░╨║╨║╨░╤Г╨╜╤В╤Л\",\"nav-settings\",\"#8ff0a4\");" +
  "  h+=dashActionCard(\"create_new_folder\",\"╨Э╨╛╨▓╨░╤П ╨┐╨░╨┐╨║╨░\",\"╨б╤А╨░╨╖╤Г ╨┐╨╡╤А╨╡╨╣╤В╨╕ ╨▓ ╤Д╨░╨╣╨╗╤Л\",\"nav-files\",\"#9ddcff\");" +
  "  h+='</section>';" +
  "  h+='<section style=\"display:grid;grid-template-columns:minmax(0,1fr);gap:18px;margin-top:18px\">';" +
  "  h+='<div class=\"card\" style=\"margin:0;padding:22px;border-radius:24px\"><div style=\"font-size:18px;font-weight:900;color:#fff;margin-bottom:14px\">╨б╨╡╨╣╤З╨░╤Б</div><div style=\"display:grid;gap:10px\"><div style=\"display:flex;justify-content:space-between;gap:12px;color:#cbc3d7\"><span>╨Р╨║╤В╨╕╨▓╨╜╤Л╨╡ ╨╖╨░╨│╤А╤Г╨╖╨║╨╕</span><b id=\"dash-active-count\">0</b></div><div style=\"display:flex;justify-content:space-between;gap:12px;color:#cbc3d7\"><span>╨Ш╤Б╤В╨╛╤А╨╕╤П URL</span><b id=\"dash-history-count\">...</b></div><div style=\"display:flex;justify-content:space-between;gap:12px;color:#cbc3d7\"><span>╨в╨╡╨║╤Г╤Й╨╕╨╣ ╤А╨╡╨╢╨╕╨╝</span><b>Cloud</b></div><div style=\"display:flex;justify-content:space-between;gap:12px;color:#cbc3d7\"><span>╨Т╨╡╤А╤Б╨╕╤П ╤Б╨░╨╣╤В╨░</span><b style=\"color:#d2bbff\">v' + SITE_VERSION + '</b></div></div></div>';" +
  "  h+='</section>';" +
  ...
  'function addDashboardUrlDownload(){var url=document.getElementById("dash-url-inp").value.trim(),name=document.getElementById("dash-name-inp").value.trim(),mode=document.getElementById("dash-mode-inp").value,st=document.getElementById("dash-url-status");if(!url){st.textContent="╨Т╤Б╤В╨░╨▓╤М URL";return;}var media=mode!=="file";if(media)name=stripInputMediaExt(name);st.textContent=media?"╨Ч╨░╨┐╤Г╤Б╨║╨░╤О ╨╝╨╡╨┤╨╕╨░-╨╖╨░╨│╤А╤Г╨╖╨║╤Г...":"╨Ф╨╛╨▒╨░╨▓╨╗╤П╤О ╨╖╨░╨│╤А╤Г╨╖╨║╤Г...";fetch(media?"/api/fm/media":"/api/fm/add-url",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:url,filename:name,path:"",mode:mode})}).then(function(r){return r.json();}).then(function(d){if(d.ok){var gid=d.gid||(d.job&&d.job.id);if(gid){knownMediaStatuses[gid]="active";markPendingUrlJob(gid,"");}document.getElementById("dash-url-inp").value="";document.getElementById("dash-name-inp").value="";st.textContent="╨Ч╨░╨│╤А╤Г╨╖╨║╨░ ╨╖╨░╨┐╤Г╤Й╨╡╨╜╨░";loadTransfers();}else st.textContent=d.error||"╨Ю╤И╨╕╨▒╨║╨░";}).catch(function(){st.textContent="╨Ю╤И╨╕╨▒╨║╨░";});}' +
  ...
  'function loadCloudSettings(){currentPath="__settings__";savePath("__settings__");clearSelection(false);setSectionChrome("settings");setNavActive("nav-settings");var bc=document.getElementById("breadcrumb");if(bc)bc.innerHTML=\'<span style="color:#a078ff;font-weight:700">╨Э╨░╤Б╤В╤А╨╛╨╣╨║╨╕</span>\';var html=\'<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:14px">\';html+=settingsCard("\u041f\u0440\u043e\u0444\u0438\u043b\u044c",\'<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px"><div id="settings-profile-avatar" style="width:48px;height:48px;border-radius:16px;background:linear-gradient(135deg,#a078ff,#6d3bd7);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:900;font-size:18px;flex:0 0 auto">?</div><div style="min-width:0;flex:1"><div id="settings-profile-login" style="font-size:12px;color:#958ea0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">@...</div><div id="settings-profile-role" style="font-size:12px;color:#d2bbff;margin-top:2px"></div></div></div><div style="font-size:12px;color:#958ea0;margin-bottom:8px">\u0418\u043c\u044f \u0432 \u043f\u0440\u043e\u0444\u0438\u043b\u0435</div><input id="cloud-profile-label" class="inp" maxlength="40" placeholder="CloudSpace" style="margin-bottom:10px"><button class="btn-primary" data-action="settings-save-profile">\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c</button><div id="cloud-profile-status" style="font-size:12px;margin-top:8px;min-height:16px"></div>\');html+=settingsCard("╨е╤А╨░╨╜╨╡╨╜╨╕╨╡ ╤Д╨░╨╣╨╗╨╛╨▓",\'<div style="font-size:12px;color:#958ea0;margin-bottom:10px">╨Р╨▓╤В╨╛╤Г╨┤╨░╨╗╨╡╨╜╨╕╨╡ ╤Б╤В╨░╤А╤Л╤Е ╤Д╨░╨╣╨╗╨╛╨▓</div><select id="cloud-retention" class="inp" style="margin-bottom:10px"><option value="1">1 ╨┤╨╡╨╜╤М</option><option value="3">3 ╨┤╨╜╤П</option><option value="7">7 ╨┤╨╜╨╡╨╣</option><option value="30">30 ╨┤╨╜╨╡╨╣</option><option value="0">╨Э╨╕╨║╨╛╨│╨┤╨░</option></select><button class="btn-primary" data-action="settings-save-retention">╨б╨╛╤Е╤А╨░╨╜╨╕╤В╤М</button><div id="cloud-retention-status" style="font-size:12px;margin-top:8px;min-height:16px"></div>\');html+=settingsCard("╨г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╤П",\'<div id="cloud-notif-status" style="font-size:12px;color:#958ea0;margin-bottom:10px">╨Я╤А╨╛╨▓╨╡╤А╤П╤О...</div><button class="btn-ghost" data-action="settings-notif"><span class="material-symbols-outlined">notifications</span> ╨а╨░╨╖╤А╨╡╤И╨╕╤В╤М ╤Г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╤П</button>\');html+=settingsCard("Speed test",\'<div style="font-size:12px;color:#958ea0;margin-bottom:10px">\u041f\u0440\u043e\u0432\u0435\u0440\u043a\u0430 \u0441\u043a\u043e\u0440\u043e\u0441\u0442\u0438 \u043c\u0435\u0436\u0434\u0443 \u0431\u0440\u0430\u0443\u0437\u0435\u0440\u043e\u043c \u0438 VPS</div><button class="btn-primary" data-action="settings-speedtest"><span class="material-symbols-outlined">speed</span> \u0417\u0430\u043f\u0443\u0441\u0442\u0438\u0442\u044c \u0442\u0435\u0441\u0442</button><div id="speed-status" style="font-size:12px;color:#958ea0;margin-top:10px;min-height:16px"></div><div id="speed-result" class="speed-result"><div class="speed-metric"><b id="speed-ping">\u2014</b><span>Ping</span></div><div class="speed-metric"><b id="speed-down">\u2014</b><span>Download</span></div><div class="speed-metric"><b id="speed-up">\u2014</b><span>Upload</span></div></div>\');html+=settingsCard("╨в╨╛╨║╨╡╨╜ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П",\'<div id="cloud-token-display" style="font-size:12px;color:#d2bbff;word-break:break-all;margin-bottom:10px">╨б╨║╤А╤Л╤В</div><div style="display:flex;gap:8px;flex-wrap:wrap"><button class="btn-ghost" data-action="settings-load-token">╨Я╨╛╨║╨░╨╖╨░╤В╤М</button><button class="btn-ghost" data-action="settings-copy-token">╨Ъ╨╛╨┐╨╕╤А╨╛╨▓╨░╤В╤М</button><button class="btn-ghost" data-action="settings-reset-token" style="color:#ffb4ab;border-color:#93000a">╨б╨▒╤А╨╛╤Б╨╕╤В╤М</button></div><div id="cloud-token-status" style="font-size:12px;margin-top:8px;min-height:16px"></div>\');html+=settingsCard("╨Я╨░╤А╨╛╨╗╤М",\'<input id="cloud-pass-current" class="inp" type="password" placeholder="╨в╨╡╨║╤Г╤Й╨╕╨╣ ╨┐╨░╤А╨╛╨╗╤М" style="margin-bottom:10px"><input id="cloud-pass-new" class="inp" type="password" placeholder="╨Э╨╛╨▓╤Л╨╣ ╨┐╨░╤А╨╛╨╗╤М" style="margin-bottom:10px"><button class="btn-primary" data-action="settings-change-password">╨б╨╝╨╡╨╜╨╕╤В╤М ╨┐╨░╤А╨╛╨╗╤М</button><div id="cloud-pass-status" style="font-size:12px;margin-top:8px;min-height:16px"></div>\');html+=\'<div id="cloud-users-section" class="card" style="margin:0;padding:18px;display:none"><div style="font-size:15px;font-weight:800;margin-bottom:12px;color:#e4e1e6">╨Р╨║╨║╨░╤Г╨╜╤В╤Л</div><div id="cloud-users-list" style="display:flex;flex-direction:column;gap:8px;margin-bottom:12px"></div><div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:10px"><input id="cloud-new-username" class="inp" placeholder="╨Ы╨╛╨│╨╕╨╜"><input id="cloud-new-password" class="inp" placeholder="╨Я╨░╤А╨╛╨╗╤М"><input id="cloud-new-label" class="inp" placeholder="╨Ш╨╝╤П"></div><button class="btn-primary" data-action="settings-add-user">╨Ф╨╛╨▒╨░╨▓╨╕╤В╤М ╨░╨║╨║╨░╤Г╨╜╤В</button><div id="cloud-users-status" style="font-size:12px;margin-top:8px;min-height:16px"></div></div>\';html+="</div>";document.getElementById("file-area").innerHTML=html;loadCloudProfile();loadCloudRetention();updateCloudNotifStatus();loadCloudUsers();}' +
  ...
  'function saveCloudRetention(){var v=document.getElementById("cloud-retention").value;fetch("/api/settings",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({retention:parseInt(v,10)})}).then(function(r){return r.json();}).then(function(d){setCloudStatus("cloud-retention-status",d.ok?"╨б╨╛╤Е╤А╨░╨╜╨╡╨╜╨╛":(d.error||"╨Ю╤И╨╕╨▒╨║╨░"),!!d.ok);}).catch(function(){setCloudStatus("cloud-retention-status","╨Ю╤И╨╕╨▒╨║╨░",false);});}' +
  'function updateCloudNotifStatus(){var el=document.getElementById("cloud-notif-status");if(!el)return;if(!("Notification" in window)){el.textContent="╨С╤А╨░╤Г╨╖╨╡╤А╨╜╤Л╨╡ ╤Г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╤П ╨╜╨╡╨┤╨╛╤Б╤В╤Г╨┐╨╜╤Л";return;}el.textContent=Notification.permission==="granted"?"╨г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╤П ╨▓╨║╨╗╤О╤З╨╡╨╜╤Л":Notification.permission==="denied"?"╨г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╤П ╨╖╨░╨┐╤А╨╡╤Й╨╡╨╜╤Л ╨▓ ╨▒╤А╨░╤Г╨╖╨╡╤А╨╡":"╨г╨▓╨╡╨┤╨╛╨╝╨╗╨╡╨╜╨╕╤П ╨╡╤Й╨╡ ╨╜╨╡ ╤А╨░╨╖╤А╨╡╤И╨╡╨╜╤Л";}' +
  'function requestCloudNotif(){if(!("Notification" in window))return;Notification.requestPermission().then(updateCloudNotifStatus);}' +
  'function loadCloudToken(){fetch("/api/mytoken").then(function(r){return r.json();}).then(function(d){document.getElementById("cloud-token-display").textContent=d.token||"";setCloudStatus("cloud-token-status","╨в╨╛╨║╨╡╨╜ ╨╖╨░╨│╤А╤Г╨╢╨╡╨╜",true);}).catch(function(){setCloudStatus("cloud-token-status","╨Ю╤И╨╕╨▒╨║╨░ ╤В╨╛╨║╨╡╨╜╨░",false);});}' +
  'function copyCloudToken(){var t=(document.getElementById("cloud-token-display")||{}).textContent||"";if(!t||t==="╨б╨║╤А╤Л╤В"){loadCloudToken();return;}navigator.clipboard&&navigator.clipboard.writeText(t).then(function(){setCloudStatus("cloud-token-status","╨б╨║╨╛╨┐╨╕╤А╨╛╨▓╨░╨╜╨╛",true);});}' +
  'function resetCloudToken(){if(!confirm("╨б╨▒╤А╨╛╤Б╨╕╤В╤М ╤В╨╛╨║╨╡╨╜ ╤А╨░╤Б╤И╨╕╤А╨╡╨╜╨╕╤П? ╨б╤В╨░╤А╤Л╨╣ ╨┐╨╡╤А╨╡╤Б╤В╨░╨╜╨╡╤В ╤А╨░╨▒╨╛╤В╨░╤В╤М."))return;fetch("/api/mytoken/reset",{method:"POST"}).then(function(r){return r.json();}).then(function(d){document.getElementById("cloud-token-display").textContent=d.token||"";setCloudStatus("cloud-token-status","╨Э╨╛╨▓╤Л╨╣ ╤В╨╛╨║╨╡╨╜ ╨│╨╛╤В╨╛╨▓",true);}).catch(function(){setCloudStatus("cloud-token-status","╨Ю╤И╨╕╨▒╨║╨░ ╤Б╨▒╤А╨╛╤Б╨░",false);});}' +
  ...
  '      \'<button class="filter-pill\'+(activeFilter==="all"?" active":"")+\'" data-action="filter-category" data-filter="all">╨Т╤Б╨╡</button>\' +' +
  '      \'<button class="filter-pill\'+(activeFilter==="images"?" active":"")+\'" data-action="filter-category" data-filter="images">╨Ш╨╖╨╛╨▒╤А╨░╨╢╨╡╨╜╨╕╤П</button>\' +' +
  '      \'<button class="filter-pill\'+(activeFilter==="videos"?" active":"")+\'" data-action="filter-category" data-filter="videos">╨Т╨╕╨┤╨╡╨╛</button>\' +' +
  '      \'<button class="filter-pill\'+(activeFilter==="music"?" active":"")+\'" data-action="filter-category" data-filter="music">╨Ь╤Г╨╖╤Л╨║╨░</button>\' +' +
  '      \'<button class="filter-pill\'+(activeFilter==="docs"?" active":"")+\'" data-action="filter-category" data-filter="docs">╨Ф╨╛╨║╤Г╨╝╨╡╨╜╤В╤Л</button>\' +' +
  '      \'<button class="filter-pill\'+(activeFilter==="archives"?" active":"")+\'" data-action="filter-category" data-filter="archives">╨Р╤А╤Е╨╕╨▓╤Л</button>\' +' +
  '    \'</div>\';' +
  '  }' +
  ...
  '  for(var i=0;i<files.length;i++){var f=files[i],fp=base?(base+"/"+f.name):f.name,checked=!!selectedItems[fp],isNew=isNewFile(fp),badge=isNew?\'<span class="new-badge">New</span>\':"";h+=\'<div class="file-row \'+(checked?"selected ":"")+(isNew?"is-new":"")+\'" draggable="true" data-fp="\'+H(fp)+\'" data-name="\'+H(f.name)+\'" data-dir="\'+f.isDir+\'">\';h+=\'<input class="select-check" type="checkbox" data-action="select-item" data-fp="\'+H(fp)+\'" data-name="\'+H(f.name)+\'" data-dir="\'+f.isDir+\'"\'+(checked?" checked":"")+">";h+=fileThumb(f.name,fp,f.isDir);if(f.isDir)h+=\'<div data-meta="\'+(f.fileCount!=null?H(f.fileCount+" ╨╛╨▒╤К╨╡╨║╤В╨╛╨▓"):"╨Я╨░╨┐╨║╨░")+\'" style="flex:1;font-weight:500;color:#d0bcff;cursor:pointer;pointer-events:none">\'+H(f.name)+badge+"</div>";else h+=\'<div data-meta="\'+H(fmtSize(f.size)+" ┬╖ "+fmtDate(f.mtime))+\'" style="flex:1;color:#e4e1e6;pointer-events:none">\'+H(f.name)+badge+"</div>";h+=\'<div style="width:100px;text-align:right;font-size:13px;color:#958ea0;pointer-events:none">\'+(f.isDir?"тАФ":fmtSize(f.size))+"</div>";h+=\'<div style="width:130px;text-align:right;font-size:12px;color:#494454;pointer-events:none">\'+fmtDate(f.mtime)+"</div>";h+=\'<button class="btn-ghost item-menu-btn" data-action="item-menu" data-fp="\'+H(fp)+\'" data-name="\'+H(f.name)+\'" data-dir="\'+f.isDir+\'" title="Actions"><span class="material-symbols-outlined">more_vert</span></button></div>\';}' +
  '  return h+"</div>";' +
  '}' +
  ...
  '  document.getElementById("file-area").innerHTML=\'<div style="color:#958ea0;padding:40px;text-align:center">╨Я╨╛╨╕╤Б╨║...</div>\';' +
  ...
  '    if(!entries.length){document.getElementById("file-area").innerHTML=\'<div style="color:#494454;padding:40px;text-align:center">╨Э╨╕╤З╨╡╨│╨╛ ╨╜╨╡ ╨╜╨░╨╣╨┤╨╡╨╜╨╛</div>\';return;}' +
  '    document.getElementById("file-area").innerHTML=fileListHtml(entries,"");' +
  '  })' +
  '  .catch(function(){document.getElementById("file-area").innerHTML=\'<div style="color:#ffb4ab;padding:24px">╨Ю╤И╨╕╨▒╨║╨░</div>\';});' +
  '}' +
  ...
  '  .then(function(r){return r.json();}).then(function(d){closeMkdirModal();if(d.ok)navigateTo(p);else alert(d.error||"╨Ю╤И╨╕╨▒╨║╨░");});' +
  '}' +

  /* тФАтФА RENAME тФАтФА */
  ...
  '  .then(function(r){return r.json();}).then(function(d){closeRenameModal();if(d.ok)navigateTo(activePath());else alert(d.error||"╨Ю╤И╨╕╨▒╨║╨░");});' +
  '}' +

  /* тФАтФА DELETE тФАтФА */
  ...
  'function addUrlDownload(){var url=document.getElementById("url-dl-inp").value.trim();var name=document.getElementById("url-name-inp").value.trim();var mode=document.getElementById("url-mode-inp").value;var st=document.getElementById("url-status");var folder=activePath();if(!url){st.textContent="╨Т╤Б╤В╨░╨▓╤М URL";return;}var media=mode!=="file";if(media)name=stripInputMediaExt(name);st.textContent=media?"╨Ч╨░╨┐╤Г╤Б╨║╨░╤О ╨╝╨╡╨┤╨╕╨░-╨╖╨░╨│╤А╤Г╨╖╨║╤Г...":"╨Ф╨╛╨▒╨░╨▓╨╗╤П╤О ╨╖╨░╨│╤А╤Г╨╖╨║╤Г...";fetch(media?"/api/fm/media":"/api/fm/add-url",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:url,filename:name,path:folder,mode:mode})}).then(function(r){return r.json();}).then(function(d){if(d.ok){var gid=d.gid||(d.job&&d.job.id);if(gid){knownMediaStatuses[gid]="active";markPendingUrlJob(gid,folder);}st.textContent=media?"╨Ь╨╡╨┤╨╕╨░-╨╖╨░╨│╤А╤Г╨╖╨║╨░ ╨╖╨░╨┐╤Г╤Й╨╡╨╜╨░":"╨Ч╨░╨│╤А╤Г╨╖╨║╨░ ╨┤╨╛╨▒╨░╨▓╨╗╨╡╨╜╨░";closeUrlModal();loadTransfers();}else st.textContent=d.error||"╨Ю╤И╨╕╨▒╨║╨░";}).catch(function(){st.textContent="╨Ю╤И╨╕╨▒╨║╨░";});}' +
  ...
  'function metaRow(label,value){return \'<div class="meta-row"><div class="meta-lbl">\'+H(label)+\'</div><div class="meta-val">\'+(value||"тАФ")+\'</div></div>\';}' +
  'function renderPreviewInfo(fp,name){var info=document.getElementById("preview-info");info.innerHTML=\'<div style="font-size:12px;color:#958ea0">╨Ч╨░╨│╤А╤Г╨╖╨║╨░ ╨╕╨╜╤Д╨╛╤А╨╝╨░╤Ж╨╕╨╕...</div>\';fetch("/api/fm/meta?path="+encodeURIComponent(fp)).then(function(r){return r.json();}).then(function(m){if(m.error){info.innerHTML=metaRow("╨Ш╨╝╤П",name)+metaRow("╨Я╤Г╤В╤М",fp);return;}var links=m.publicLinks||[];var linkHtml=links.length?links.map(function(x){var full=window.location.origin+x.url;return \'<div style="display:flex;align-items:center;gap:6px;justify-content:flex-end"><a href="\'+H(x.url)+\'" target="_blank" style="color:#d2bbff;min-width:0;overflow:hidden;text-overflow:ellipsis">\'+H(full)+\'</a><button class="btn-ghost" data-action="qr-link" data-url="\'+H(full)+\'" style="padding:2px 7px;min-height:24px;font-size:11px">QR</button></div>\';}).join(""):"╨Э╨╡╤В";var h="";h+=metaRow("╨Ш╨╝╤П",m.name||name);h+=metaRow("╨Я╤Г╤В╤М",m.path||fp);h+=metaRow("╨а╨░╨╖╨╝╨╡╤А",m.isDir?"тАФ":fmtSize(m.size));h+=metaRow("╨в╨╕╨┐",m.isDir?"╨Я╨░╨┐╨║╨░":(m.ext?m.ext.slice(1).toUpperCase():"╨д╨░╨╣╨╗"));h+=metaRow("╨Ч╨░╨│╤А╤Г╨╢╨╡╨╜",fmtDateTime(m.created));h+=metaRow("╨Ш╨╖╨╝╨╡╨╜╤С╨╜",fmtDateTime(m.mtime));h+=metaRow("╨Я╤Г╨▒╨╗╨╕╤З╨╜╨░╤П ╤Б╤Б╤Л╨╗╨║╨░",linkHtml);info.innerHTML=h;}).catch(function(){info.innerHTML=metaRow("╨Ш╨╝╤П",name)+metaRow("╨Я╤Г╤В╤М",fp);});}' +
  ...
  'function renderDocPreview(fp,name){var body=openPreviewShell(fp,name);body.innerHTML=\'<div style="color:#958ea0;padding:20px">╨Ч╨░╨│╤А╤Г╨╖╨║╨░ ╨┤╨╛╨║╤Г╨╝╨╡╨╜╤В╨░...</div>\';fetch("/api/fm/doc-preview?path="+encodeURIComponent(fp)).then(function(r){return r.json();}).then(function(d){if(!d.ok){body.innerHTML=\'<div style="padding:24px;color:#ffb4ab">\'+H(d.error||"╨Э╨╡ ╤Г╨┤╨░╨╗╨╛╤Б╤М ╨╛╤В╨║╤А╤Л╤В╤М ╨┤╨╛╨║╤Г╨╝╨╡╨╜╤В")+\'</div>\';return;}if(d.type==="sheet"){var sheets=d.sheets||[];if(!sheets.length){body.innerHTML=\'<div style="padding:24px;color:#958ea0">╨Т ╤В╨░╨▒╨╗╨╕╤Ж╨╡ ╨╜╨╡╤В ╨╗╨╕╤Б╤В╨╛╨▓</div>\';return;}var h=\'<div class="doc-tabs">\';for(var i=0;i<sheets.length;i++)h+=\'<button class="doc-tab" data-sheet="\'+i+\'">\'+H(sheets[i].name)+\'</button>\';h+=\'</div><div id="sheet-preview" class="doc-preview">\'+(sheets[0].html||"")+\'</div>\';body.innerHTML=h;body.querySelectorAll("[data-sheet]").forEach(function(btn){btn.addEventListener("click",function(){var idx=parseInt(btn.dataset.sheet,10)||0;document.getElementById("sheet-preview").innerHTML=sheets[idx].html||"";});});return;}body.innerHTML=\'<div class="doc-preview">\'+(d.html||"")+\'</div>\';}).catch(function(){body.innerHTML=\'<div style="padding:24px;color:#ffb4ab">╨Ю╤И╨╕╨▒╨║╨░ ╨┐╤А╨╡╨┤╨┐╤А╨╛╤Б╨╝╨╛╤В╤А╨░</div>\';});}' +
  'function renderArchivePreview(fp,name){var body=openPreviewShell(fp,name);body.innerHTML=\'<div style="color:#958ea0;padding:20px">╨з╨╕╤В╨░╤О ╨░╤А╤Е╨╕╨▓...</div>\';fetch("/api/fm/archive/list?path="+encodeURIComponent(fp)).then(function(r){return r.json();}).then(function(d){if(!d.ok){body.innerHTML=\'<div style="padding:24px;color:#ffb4ab">\'+H(d.error||"╨Э╨╡ ╤Г╨┤╨░╨╗╨╛╤Б╤М ╨╛╤В╨║╤А╤Л╤В╤М ╨░╤А╤Е╨╕╨▓")+\'<div style="margin-top:8px;color:#958ea0;font-size:12px">\'+H(d.details||"")+\'</div></div>\';return;}var items=d.entries||[];if(!items.length){body.innerHTML=\'<div style="padding:24px;color:#958ea0">╨Р╤А╤Е╨╕╨▓ ╨┐╤Г╤Б╤В</div>\';return;}var h=\'<div style="display:flex;justify-content:space-between;gap:10px;margin-bottom:10px;color:#958ea0;font-size:12px"><span>\'+items.length+\' items</span><a class="btn-ghost" href="/api/fm/download?path=\'+encodeURIComponent(fp)+\'" download style="text-decoration:none;padding:4px 10px;min-height:28px">╨б╨║╨░╤З╨░╤В╤М ╨░╤А╤Е╨╕╨▓</a></div><table class="archive-table"><tbody>\';items.forEach(function(x){var icon=x.isDir?"folder":"draft";var cls=x.isDir?"archive-path archive-dir":"archive-path";h+=\'<tr><td style="width:28px"><span class="material-symbols-outlined" style="font-size:18px">\'+icon+\'</span></td><td><div class="\'+cls+\'" title="\'+H(x.path)+\'">\'+H(x.path)+\'</div></td><td style="width:76px;color:#958ea0;white-space:nowrap">\'+(x.isDir?"":fmtSize(x.size||0))+\'</td><td style="width:42px;text-align:right">\'+(x.isDir?"":\'<a class="btn-ghost" href="/api/fm/archive/download?path=\'+encodeURIComponent(fp)+\'&entry=\'+encodeURIComponent(x.path)+\'" download style="padding:3px 8px;min-height:24px;text-decoration:none">тЖУ</a>\')+\'</td></tr>\';});h+=\'</tbody></table>\';body.innerHTML=h;}).catch(function(){body.innerHTML=\'<div style="padding:24px;color:#ffb4ab">╨Ю╤И╨╕╨▒╨║╨░ ╤З╤В╨╡╨╜╨╕╤П ╨░╤А╤Е╨╕╨▓╨░</div>\';});}' +
  ...
  '  .then(function(r){return r.json();}).then(function(d){if(d.ok)navigateTo(activePath());else alert(d.error||"╨Ю╤И╨╕╨▒╨║╨░");});' +
  '}' +
  ...
  '  if(!confirm("╨г╨┤╨░╨╗╨╕╤В╤М ╨▓╤Л╨▒╤А╨░╨╜╨╜╤Л╨╡: " + items.length + "?"))return;' +
  ...
  '  .then(function(results){var failed=results.filter(function(x){return !x.ok;});clearSelection(false);refreshCurrent();if(failed.length)alert("╨Э╨╡ ╤Г╨┤╨░╨╗╨╛╤Б╤М ╤Г╨┤╨░╨╗╨╕╤В╤М: "+failed.length);})' +
  '  .catch(function(){alert("╨Ю╤И╨╕╨▒╨║╨░ ╤Г╨┤╨░╨╗╨╡╨╜╨╕╤П");});' +
  '}' +
  ...
  '  status.textContent="0%";title.textContent="╨Ч╨░╨│╤А╤Г╨╖╨║╨░ ╤Д╨░╨╣╨╗╨╛╨▓";' +
  ...
  '      if(speedEl)speedEl.textContent=fmtSize(Math.max(0,bps))+"/╤Б";' +
  ...
  '        etaEl.textContent=secs>3600?(Math.ceil(secs/3600)+" ╤З"):secs>60?(Math.ceil(secs/60)+" ╨╝╨╕╨╜"):(secs+" ╤Б");' +
  '      }' +
  '    }' +
  '  };' +
  '  xhr.onload=function(){' +
  ...
  '      status.textContent="╨У╨╛╤В╨╛╨▓╨╛";title.textContent="╨д╨░╨╣╨╗╤Л ╨╖╨░╨│╤А╤Г╨╢╨╡╨╜╤Л";' +
  '      var elapsed=(Date.now()-startTime)/1000;var avgSpd=elapsed>0?totalBytes/elapsed:0;' +
  '      if(speedEl)speedEl.textContent="Avg: "+fmtSize(avgSpd)+"/╤Б";' +
  ...
  '    }else{status.textContent="╨Ю╤И╨╕╨▒╨║╨░ "+xhr.status;}' +
  '  };' +
  '  xhr.onerror=function(){uploadBusy=false;status.textContent="╨Ю╤И╨╕╨▒╨║╨░ ╤Б╨╛╨╡╨┤╨╕╨╜╨╡╨╜╨╕╤П";};' +
  '  xhr.onabort=function(){uploadBusy=false;status.textContent="╨Ч╨░╨│╤А╤Г╨╖╨║╨░ ╨╛╤В╨╝╨╡╨╜╨╡╨╜╨░";};' +
  '  xhr.send(fd);' +
  '}' +
  ...
  '  var h="";' +
  '  if(isDir){' +
  '    h+=\'<div class="ctx-item" data-ctx="open">\u{1F4C2} ╨Ю╤В╨║╤А╤Л╤В╤М</div>\';' +
  '    h+=\'<div class="ctx-item" data-ctx="download">ЁЯУж ╨б╨║╨░╤З╨░╤В╤М ZIP</div>\';' +
  '  }else{' +
  '    h+=\'<div class="ctx-item" data-ctx="download">тЖУ ╨б╨║╨░╤З╨░╤В╤М</div>\';' +
  '  }' +
  '  if(!isDir)h+=\'<div class="ctx-item" data-ctx="preview">ЁЯСБ ╨Я╤А╨╡╨┤╨┐╤А╨╛╤Б╨╝╨╛╤В╤А</div>\';' +
  '  h+=\'<div class="ctx-sep"></div>\';' +
  '  h+=\'<div class="ctx-item" data-ctx="share">ЁЯФЧ ╨Я╤Г╨▒╨╗╨╕╤З╨╜╨░╤П ╤Б╤Б╤Л╨╗╨║╨░</div>\';' +
  '  if(!isDir)h+=\'<div class="ctx-item" data-ctx="share-manage"><span class="material-symbols-outlined" style="font-size:18px;vertical-align:-4px">admin_panel_settings</span> ╨г╨┐╤А╨░╨▓╨╗╨╡╨╜╨╕╨╡ ╤Б╤Б╤Л╨╗╨║╨░╨╝╨╕</div>\';' +
  '  h+=\'<div class="ctx-item" data-ctx="rename">тЬПя╕П ╨Я╨╡╤А╨╡╨╕╨╝╨╡╨╜╨╛╨▓╨░╤В╤М</div>\';' +
  '  h+=\'<div class="ctx-item" data-ctx="copypath">\u{1F4CB} ╨Ъ╨╛╨┐╨╕╤А╨╛╨▓╨░╤В╤М ╨┐╤Г╤В╤М</div>\';' +
  '  h+=\'<div class="ctx-sep"></div>\';' +
  '  h+=\'<div class="ctx-item danger" data-ctx="delete">\u{1F5D1}я╕П ╨г╨┤╨░╨╗╨╕╤В╤М</div>\';' +
  '  m.innerHTML=h;' +
  ...
  /* тФАтФА CLICK DELEGATION тФАтФА */
  ...
  '  else if(action==="transfer-remove"){if(confirm("╨г╨▒╤А╨░╤В╤М ╨╖╨░╨│╤А╤Г╨╖╨║╤Г?"))fetch("/api/downloads/"+encodeURIComponent(el.dataset.gid),{method:"DELETE"}).then(loadTransfers);}' +
  '  else if(action==="media-cancel"){if(confirm("╨Ю╤В╨╝╨╡╨╜╨╕╤В╤М ╨╝╨╡╨┤╨╕╨░-╨╖╨░╨│╤А╤Г╨╖╨║╤Г?"))fetch("/api/fm/media-jobs/"+encodeURIComponent(el.dataset.job),{method:"DELETE"}).then(loadTransfers);}' +
  ...
  '  else if(action==="show-history-error"){alert(el.dataset.error||"╨Ю╤И╨╕╨▒╨║╨░ ╨╖╨░╨│╤А╤Г╨╖╨║╨╕");}' +
  ...
  /* тФАтФА CLICK on file row to open folder тФАтФА */
  'document.addEventListener("click",function(e){' +
  ...
  /* тФАтФА CONTEXT MENU trigger тФАтФА */
